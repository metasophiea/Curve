parts.audio.synthesizer = function(
    ...
    this.gain = function(a){if(a==null){return mainOut.gain.value;}mainOut.gain.setTargetAtTime(a, context.currentTime, 0);};
    ...
    function makeOSC(
        ...
        return new function(){
            ...
            this.detune = function(a){
                this.generator.detune.setTargetAtTime(a, context.currentTime, 0);
            };

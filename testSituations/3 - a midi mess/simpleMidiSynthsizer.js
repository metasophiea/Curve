function makeSimpleMidiSynthsizer(x,y){
    //styling
    var style = {
    ...
    //elements
        //main
            var _mainObject = parts.basic.g('simpleMidiSynthsizer', x, y);
    ...
    //wiring
        ...
        _mainObject.io.dataIn_midiNote.receive = function(address,data){ if(address != 'midiNote'){return;} synthesizer.perform(data); };

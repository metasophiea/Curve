...
var pulseGenerator_1 = __globals.utility.workspace.placeAndReturnObject( objects.pulseGenerator_hyper(870, -15) );
var basicSequencer_midiOut_1 = __globals.utility.workspace.placeAndReturnObject( objects.basicSequencer_midiOut(10, 10) );
var basicSynthesizer_1 = __globals.utility.workspace.placeAndReturnObject( objects.basicSynthesizer(-250, 40) );
var audio_duplicator_1 = __globals.utility.workspace.placeAndReturnObject( objects.audio_duplicator(-345, 50) );
var audio_sink_1 = __globals.utility.workspace.placeAndReturnObject( objects.audio_sink(-490, 50) );

console.log('%cTesting - __globals.utility.misc', 'font-size:15px; font-weight:bold;');
    ...
    tester( __globals.utility.misc.blendColours('rgba(0,0,0,0)', 'rgba(255,255,255,1)', 0), 'rgba(0,0,0,0)' );
    tester( __globals.utility.misc.blendColours('rgba(0,0,0,0)', 'rgba(255,255,255,1)', 1), 'rgba(255,255,255,1)' );
        tester( __globals.utility.misc.blendColours('rgba(0,0,0,0)', 'rgba(255,255,255,1)', 0.5), 'rgba(127.5,127.5,127.5,0.5)' );
        tester( __globals.utility.misc.blendColours('rgba(247, 180, 112, 0.5)', 'rgba(255, 173, 102,1)', 0.5), 'rgba(251,176.5,107,0.75)' );

    console.log('%c- multiBlendColours', 'font-weight: bold;');
        tester( __globals.utility.misc.multiBlendColours(['rgba(0,0,0,0)', 'rgba(255,255,255,1)'], 0.5), 'rgba(127.5,127.5,127.5,0.5)' );
        tester( __globals.utility.misc.multiBlendColours(['rgba(0,0,0,0)', 'rgba(255,255,255,1)'], 0), 'rgba(0,0,0,0)' );
        tester( __globals.utility.misc.multiBlendColours(['rgba(0,0,0,0)', 'rgba(255,255,255,1)'], 1), 'rgba(255,255,255,1)' );
        tester( __globals.utility.misc.multiBlendColours( ['rgba(150,100,150,0.75)','rgba(255,255,255,0.75)'], 0.5 ), 'rgba(202.5,177.5,202.5,0.75)' );
        tester( __globals.utility.misc.multiBlendColours( ['rgba(150,100,150,0.75)','rgba(0,0,0,1)','rgba(255,255,255,0.75)'], 0.25 ), 'rgba(75,50,75,0.875)' );
        tester( __globals.utility.misc.multiBlendColours( ['rgba(0,0,0,1)','rgba(150,100,150,0.75)','rgba(0,0,0,1)','rgba(255,255,255,0.75)'], 0.99 ), 'rgba(247.34999999999994,247.34999999999994,247.34999999999994,0.7575000000000001)' );

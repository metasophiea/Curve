var canvas_sequencer = function(
    ...
    //unpack styles
        backingStyle = __globals.utility.element.styleExtractor(backingStyle);
        selectionAreaStyle = __globals.utility.element.styleExtractor(selectionAreaStyle);
        blockStyle_body = blockStyle_body.map(a => __globals.utility.element.styleExtractor(a));
        blockStyle_bodyGlow = blockStyle_bodyGlow.map(a => __globals.utility.element.styleExtractor(a));
        blockStyle_handle = __globals.utility.element.styleExtractor(blockStyle_handle);
        horizontalStripStyle_glow = __globals.utility.element.styleExtractor(horizontalStripStyle_glow);
        horizontalStripStyle_styles = horizontalStripStyle_styles.map(a => __globals.utility.element.styleExtractor(a));
        verticalStripStyle_glow = __globals.utility.element.styleExtractor(verticalStripStyle_glow);
        verticalStripStyle_styles = verticalStripStyle_styles.map(a => __globals.utility.element.styleExtractor(a));
        playheadStyle = __globals.utility.element.styleExtractor(playheadStyle);
    ...
    //elements
        //main
        var obj = __globals.utility.misc.elementMaker('g',id,{x:x, y:y});
        //canvas
            var canvas = __globals.utility.misc.elementMaker('canvas',id,{width:width, height:height, resolution:5});

...
_canvas_.layers.registerFunctionForLayer("core", function(){
    ...
    _canvas_.core.arrangement.append(dynamicGroup);
        ...
        additionalSubGroup = _canvas_.core.element.create('Group','additionalSubGroup');
        dynamicGroup.append(additionalSubGroup);
        ...
        additionalSubGroup.append(rectangle_1);
        ...
        additionalSubGroup.append(rectangle_2);
        ...
        additionalSubGroup.append(rectangle_3);
        ...
        additionalSubGroup.append(rectangle_4);
        ...
        additionalSubGroup.append(rectangle_5);
        // rectangle_6 = _canvas_.core.element.create('Polygon','test_rectangle_6');
        // rectangle_6.unifiedAttribute({
        //     pointsAsXYArray:[{x:120,y:120}, {x:120+200,y:120}, {x:120+200,y:120+20}, {x:120,y:120+20}],
        //     colour:rc(),
        // });
        // additionalSubGroup.append(rectangle_6);

    _canvas_.core.if.operator.element.executeMethod.setDotFrame(0,true);
    ...
    function func(tick){
        ...
        // _canvas_.core.viewport.angle(tick);
        rectangle_5.angle(tick);
    }

    // _canvas_.core.viewport.position(-200,0);
    ...
    // _canvas_.core.viewport.angle(0.01);
    // _canvas_.core.viewport.position(0,141);
    // setTimeout(() => {

...
var tmp = _canvas_.core.shape.create('rectangleWithRoundEnds');
    tmp.name = 'rectangleWithRoundEnds_1';
    tmp.stopAttributeStartedExtremityUpdate = true;
    tmp.x(110);
    tmp.y(40);
    tmp.width(60)
    ...
    _canvas_.core.arrangement.append(tmp);
var tmp = _canvas_.core.shape.create('rectangleWithRoundEnds');
    tmp.name = 'rectangleWithRoundEnds_2';
    tmp.stopAttributeStartedExtremityUpdate = true;
    tmp.x(180);
    tmp.y(40);
    tmp.width(60)
    ...
    _canvas_.core.arrangement.append(tmp);
var tmp = _canvas_.core.shape.create('rectangleWithRoundEnds');
    tmp.name = 'rectangleWithRoundEnds_3';
    tmp.stopAttributeStartedExtremityUpdate = true;
    tmp.x(250);
    tmp.y(40);
    tmp.width(60)

_canvas_.layers.registerFunctionForLayer("core", function(){
    ...
    _canvas_.core.arrangement.append(group_1);
        ...
        rectangle_1.unifiedAttribute({x:10, y:10, width:60, height:60, angle:0.1, colour:{r:1, g:0, b:0, a:1}});
    ...
    group_2.framebufferActive(true);
        ...
        rectangle_2.unifiedAttribute({x:80, y:10, width:60, height:60, angle:0.1, colour:{r:0, g:1, b:0, a:1}});
    ...
    group_3.framebufferActive(true);
        ...
        rectangle_3.unifiedAttribute({x:150, y:10, width:60, height:60, angle:0.1, colour:{r:0, g:0, b:1, a:1}});

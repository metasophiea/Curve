osc_1 = new _canvas_.library.audio.audioWorklet.production.only_js.oscillator(_canvas_.library.audio.context);
gain_1 = new _canvas_.library.audio.audioWorklet.production.only_js.gain(_canvas_.library.audio.context);

...
// ];
const angles = _canvas_.library.math.curveGenerator.linear(5,-0.25,-1.75);
// const angles = _canvas_.library.math.curveGenerator.halfSigmoid_down(11,-0.25,-1.75,3/4);

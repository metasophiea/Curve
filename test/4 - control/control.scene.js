...
var unit = _canvas_.interface.unit.collection['test']['testUnit_2'](0,0,0);
...
var unit = _canvas_.interface.unit.collection['test']['testUnit_4'](10,10,1);
unit.collection = 'test';
tester(
    _canvas_.control.scene.documentUnits([unit]),
    [
...
tester( _canvas_.system.pane.getMiddlegroundPane(units[0]).getAddress(), '/root/middleground/middle' );
tester( _canvas_.system.pane.getMiddlegroundPane(units[1]).getAddress(), '/root/middleground/middle' );
...
tester( _canvas_.system.pane.getMiddlegroundPane(units[0]).getAddress(), '/root/middleground/front' );
tester( _canvas_.system.pane.getMiddlegroundPane(units[1]).getAddress(), '/root/middleground/front' );
tester( units[0].io._.test_connectionNode1.getForeignNode().parent.getAddress(), units[1].getAddress() );

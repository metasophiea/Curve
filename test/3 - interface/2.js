...
var design = {
    ...
    // spaceOutline: true,
    elements:[
        {collection:'basic', type:'rectangle', name:'rectangle0', data:{ x:0, y:0,   width:50, height:50, style:{fill:'rgba(255,0,0,1)'} }},
        {collection:'basic', type:'rectangle', name:'rectangle1', data:{ x:50, y:0,  width:50, height:50, style:{fill:'rgba(0,255,0,1)'} }},
        {collection:'basic', type:'rectangle', name:'rectangle2', data:{ x:50, y:50, width:50, height:50, style:{fill:'rgba(255,255,0,1)'} }, grapple:true},
        {collection:'basic', type:'rectangle', name:'rectangle3', data:{ x:0, y:50,  width:50, height:50, style:{fill:'rgba(0,0,255,1)'} }},

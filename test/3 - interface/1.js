...
//control
    ...
    //button
        var br_1 = _canvas_.interface.part.builder( 'control', 'button_rectangle', 'test_button_rectangle1', {x:580,y:0,text_centre:'rectangle',style:{text__hover__colour:{r:1,g:0,b:0,a:1}}} ); controlGroup.append(br_1);
        var bc_1 = _canvas_.interface.part.builder( 'control', 'button_circle', 'test_button_circle1', {x:595,y:37.5,text_centre:'circle',style:{text__hover__colour:{r:1,g:0,b:0,a:1}}} ); controlGroup.append(bc_1);
        var bp_1 = _canvas_.interface.part.builder( 'control', 'button_polygon', 'test_button_polygon1', {
            x:580,y:55, points:[{x:0,y:5},{x:5,y:0}, {x:25,y:0},{x:30,y:5}, {x:30,y:25},{x:25,y:30}, {x:5,y:30},{x:0,y:25}],style:{text__hover__colour:{r:1,g:0,b:0,a:1}},
            text_centre:'polygon'
    ...
    //list
        var l_1 = _canvas_.interface.part.builder( 'control', 'list', 'test_list', {

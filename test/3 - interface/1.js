...
//display
    ...
    displayGroup.append( _canvas_.interface.part.builder( 'display', 'glowbox_rect', 'test_glowbox_rect', {x:0,y:0} ) );
    ...
    displayGroup.append( _canvas_.interface.part.builder( 'display', 'level', 'test_level1', {x:190, y:0} ) );
    displayGroup.append( _canvas_.interface.part.builder( 'display', 'meter_level', 'test_meterLevel1', {x:215, y:0} ) );
    displayGroup.append( _canvas_.interface.part.builder( 'display', 'audio_meter_level', 'test_audioMeterLevel1', {x:240, y:0} ) );
...
//control
    ...
    //slide
        var s_1 = _canvas_.interface.part.builder( 'control', 'slide', 'test_slide1', {x:0,y:0} ); controlGroup.append( s_1 );
        var si_1 = _canvas_.interface.part.builder( 'control', 'slide_image', 'test_slide_image1', {
            x:12.5,y:0,
        ...
        var si_2 = _canvas_.interface.part.builder( 'control', 'slide_image', 'test_slide_image2', {

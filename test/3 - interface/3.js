...
_canvas_.layers.registerFunctionForLayer("interface", function(){
    ...
    _canvas_.core.viewport.position(35,0);
    ...
    //segment displays
        ...
        //readout_sevenSegmentDisplay
            partsCreated.display.readout_sevenSegmentDisplay = _canvas_.interface.part.builder('display', 'readout_sevenSegmentDisplay', 'test_readout_sevenSegmentDisplay', {x:85, y:0, resolution:5});
        ...
        //readout_sevenSegmentDisplay (static)
            partsCreated.display.readout_sevenSegmentDisplay_static = _canvas_.interface.part.builder('display', 'readout_sevenSegmentDisplay', 'test_readout_sevenSegmentDisplay_static', {x:85, y:35, static:true, resolution:5});
        ...
        //readout_sixteenSegmentDisplay
            partsCreated.display.readout_sixteenSegmentDisplay = _canvas_.interface.part.builder('display', 'readout_sixteenSegmentDisplay', 'test_readout_sixteenSegmentDisplay', {x:190, y:0, resolution:5});
        ...
        //readout_sixteenSegmentDisplay (static)
            partsCreated.display.readout_sixteenSegmentDisplay_static = _canvas_.interface.part.builder('display', 'readout_sixteenSegmentDisplay', 'test_readout_sixteenSegmentDisplay_static', {x:190, y:35, static:true, resolution:5});

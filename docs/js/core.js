(function() {
    ...
    for(var __canvasElements_count = 0; __canvasElements_count < __canvasElements.length; __canvasElements_count++){
        if( __canvasElements[__canvasElements_count].hasAttribute('coreGraphics') ){
            var coreGraphics = __canvasElements[__canvasElements_count];
            coreGraphics.library = new function(){
                var library = this;
            ...
            coreGraphics.core = new function(){
                var core = new function(){
                    ...
                    var adapter = new function(){
                        ...
                        this.windowPoint2coreGraphicsPoint = function(x,y){
                            ...
                            return coreGraphics.library.math.cartesianAngleAdjust(x,y,-angle);
                        };
                        this.coreGraphicsPoint2windowPoint = function(x,y){
                            ...
                            var point = coreGraphics.library.math.cartesianAngleAdjust(x,y,angle);
                    ...
                    var shapes = new function(){
                        ...
                        this.circle = function(){
                            ...
                            this.computeExtremities = function(offset){
                                ...
                                //calculate origin
                                    point = coreGraphics.library.math.cartesianAngleAdjust(this.x,this.y,offset.a);
                                ...
                                //calculate points
                                    this.extremities.points = coreGraphics.library.math.pointsOfCircle(this.x, this.y, this.r, 10);
                                    this.extremities.points = this.extremities.points.map(function(point){
                                        point = coreGraphics.library.math.cartesianAngleAdjust(point.x,point.y,offset.a);
                                        point.x += offset.x;
                                        point.y += offset.y;
                            ...
                            function isPointWithinHitBox(x,y,shape){
                                ...
                                return coreGraphics.library.math.distanceBetweenTwoPoints( {x:x,y:y},circleCentre ) <= shape.r;
                            }
                            this.isPointWithin = function(x,y){
                                if( isPointWithinBoundingBox(x,y,this) ){
                                    return isPointWithinHitBox(x,y,this);
                                ...
                                //if dotFrame is set, draw in dots fot the points and bounding box extremities
                                    if(this.dotFrame){
                                        ...
                                        //boudning box
                                            ...
                                            var temp = adapter.coreGraphicsPoint2windowPoint(this.extremities.origin.x,this.extremities.origin.y);
                                            core.render.drawDot( temp.x, temp.y );
                                    }
                            };
                        };
                                    ...
                                    //assuming clipping is turned off
                                        if(!this.clipActive){
                                            ...
                                            //  -> this method needs to be trashed <-
                                                ...
                                                temp = coreGraphics.library.math.boundingBoxFromPoints( temp );
                            ...
                            this.getElementUnderPoint = function(x,y,static=false,getList=false){
                                ...
                                for(var a = this.children.length-1; a >= 0; a--){
                                    //if child shape is static (or any of its parents), use adjusted x and y values for 'isPointWithin' judgement
                                        var point = (this.children[a].static || static) ? adapter.coreGraphicsPoint2windowPoint(x,y) : {x:x,y:y};
                                ...
                                //collect and consolidate shape values into a neat package
                                    var shapeValue = {
                                        points: this.points.map( function(a){
                                            a = coreGraphics.library.math.cartesianAngleAdjust(a.x,a.y,offset.a);
                        ...
                        this.text = function(){
                            ...
                            this.computeExtremities = function(offset){
                                ...
                                //calculate points
                                    this.extremities.points = coreGraphics.library.math.pointsOfText( this.text, this.x, this.y, this.angle, 1/this.size, this.style.font, this.style.align, this.style.baseline );
                                    this.extremities.points = this.extremities.points.map(function(point){
                                        point = coreGraphics.library.math.cartesianAngleAdjust(point.x,point.y,offset.a);
                                        point.x += offset.x;
                                        point.y += offset.y;
                        ...
                        var offset = {x:0,y:0,a:0};
                            ...
                            //calculate them together into an offset
                                ...
                                for(var a = 1; a < offsetList.length; a++){
                                    var point = coreGraphics.library.math.cartesianAngleAdjust(offsetList[a].x,offsetList[a].y,offsetList[a-1].a);
                    ...
                    this.viewport = new function(){
                        ...
                        function adjustCanvasSize(){
                            ...
                            function dimensionAdjust(direction){
                                ...
                                var attribute = coreGraphics.getAttribute('coreGraphics'+Direction);
                                if( pageData[direction] != attribute || pageData['window'+Direction] != window['inner'+Direction] ){
                                    ...
                                    //adjust canvas dimension based on the size requirement set out in the coreGraphics attribute
                                        if(attribute == undefined){
                                            coreGraphics[direction] = pageData.defaultSize[direction] * window.devicePixelRatio;
                                            coreGraphics.style[direction] = pageData.defaultSize[direction] + "px";
                                        }else if( attribute.indexOf('%') == (attribute.length-1) ){
                                            var parentSize = coreGraphics.parentElement['offset'+Direction]
                                            var percent = parseFloat(attribute.slice(0,(attribute.length-1))) / 100;
                                            coreGraphics[direction] = parentSize * percent * window.devicePixelRatio;
                                            coreGraphics.style[direction] = parentSize * percent + "px";
                                        }else{
                                            coreGraphics[direction] = attribute * window.devicePixelRatio;
                                            coreGraphics.style[direction] = attribute + 'px';
                                        }
                        ...
                        function calculateViewportExtremities(){
                            //for each corner of the viewport; find out where they lie on the coreGraphics
                                state.points.tl = adapter.windowPoint2coreGraphicsPoint(0,0);
                                state.points.tr = adapter.windowPoint2coreGraphicsPoint(coreGraphics.width,0);
                                state.points.bl = adapter.windowPoint2coreGraphicsPoint(0,coreGraphics.height);
                                state.points.br = adapter.windowPoint2coreGraphicsPoint(coreGraphics.width,coreGraphics.height);
                            
                            //calculate a bounding box for the viewport from these points
                                state.boundingBox = coreGraphics.library.math.boundingBoxFromPoints([state.points.tl, state.points.tr, state.points.br, state.points.bl]);
                        }
                        ...
                        this.windowPoint2coreGraphicsPoint = function(x,y){ return adapter.windowPoint2coreGraphicsPoint(x,y); };
                        ...
                        this.allowKeyboardInput = function(bool){
                            ...
                            if(allowKeyboardInput){coreGraphics.setAttribute('tabIndex',1);}else{coreGraphics.removeAttribute('tabIndex');}
                        };
                    ...
                    this.stats = new function(){
                        ...
                        var framesPerSecond = {
                            compute:function(timestamp){
                                ...
                                this.rate = coreGraphics.library.math.averageArray( this.frameTimeArray );
                        ...
                        var shapeCount = {
                            recursiveCount:function(item){
                                if(item == undefined){
                                    ...
                                    item = coreGraphics.core.arrangement.get();
                                }
                            ...
                            recursivePrint:function(item,spacing=''){
                                if(item == undefined){item = coreGraphics.core.arrangement.get()}
                    ...
                    this.callback = new function(){
                        ...
                        for(var a = 0; a < callbacks.length; a++){
                            ...
                            //attachment to canvas
                                ...
                                //default
                                    coreGraphics[callbacks[a]] = function(callback){
                                        return function(event){
                                            //if core doesn't have this callback set up, just bail
                                                if( !core.callback[callback] ){return;}
                    
                                            //convert the point
                                                var p = adapter.windowPoint2coreGraphicsPoint(event.x,event.y);
                                ...
                                //special cases
                                    coreGraphics.onmouseover = function(event){
                                    ...
                                    coreGraphics.onmouseout = function(event){
                                    ...
                                    coreGraphics.onmousemove = function(event){
                                    ...
                                    coreGraphics.onkeydown = function(event){
                                    ...
                                    coreGraphics.onkeyup = function(event){
                ...
                this.viewport = new function(){
                    ...
                    this.windowPoint2coreGraphicsPoint = function(x,y){ return core.viewport.windowPoint2coreGraphicsPoint(x,y); };

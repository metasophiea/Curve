...
$jscomp.iteratorFromArray=function(g,q){$jscomp.initSymbolIterator();g instanceof String&&(g+="");var h=0,l={next:function(){if(h<g.length){var a=h++;return{value:q(a,g[a]),done:!1}}l.next=function(){return{done:!0,value:void 0}};return l.next()}};l[Symbol.iterator]=function(){return l};return l};
$jscomp.polyfill=function(g,q,h,l){if(q){h=$jscomp.global;g=g.split(".");for(l=0;l<g.length-1;l++){var a=g[l];a in h||(h[a]={});h=h[a]}g=g[g.length-1];l=h[g];q=q(l);q!=l&&null!=q&&$jscomp.defineProperty(h,g,{configurable:!0,writable:!0,value:q})}};$jscomp.polyfill("Array.prototype.keys",function(g){return g?g:function(){return $jscomp.iteratorFromArray(this,function(g){return g})}},"es6","es3");
$jscomp.polyfill("Array.from",function(g){return g?g:function(g,h,l){h=null!=h?h:function(a){return a};var a=[],d="undefined"!=typeof Symbol&&Symbol.iterator&&g[Symbol.iterator];if("function"==typeof d){g=d.call(g);for(var e=0;!(d=g.next()).done;)a.push(h.call(l,d.value,e++))}else for(d=g.length,e=0;e<d;e++)a.push(h.call(l,g[e],e));return a}},"es6","es3");
$jscomp.checkEs6ConformanceViaProxy=function(){try{var g={},q=Object.create(new $jscomp.global.Proxy(g,{get:function(h,l,a){return h==g&&"q"==l&&a==q}}));return!0===q.q}catch(h){return!1}};$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS=!1;$jscomp.ES6_CONFORMANCE=$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS&&$jscomp.checkEs6ConformanceViaProxy();$jscomp.makeIterator=function(g){var q="undefined"!=typeof Symbol&&Symbol.iterator&&g[Symbol.iterator];return q?q.call(g):$jscomp.arrayIterator(g)};
$jscomp.owns=function(g,q){return Object.prototype.hasOwnProperty.call(g,q)};
$jscomp.polyfill("WeakMap",function(g){function q(){if(!g||!Object.seal)return!1;try{var b=Object.seal({}),c=Object.seal({}),a=new g([[b,2],[c,3]]);if(2!=a.get(b)||3!=a.get(c))return!1;a.delete(b);a.set(c,4);return!a.has(b)&&4==a.get(c)}catch(n){return!1}}function h(){}function l(b){if(!$jscomp.owns(b,d)){var c=new h;$jscomp.defineProperty(b,d,{value:c})}}function a(b){var c=Object[b];c&&(Object[b]=function(b){if(b instanceof h)return b;l(b);return c(b)})}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(g&&
$jscomp.ES6_CONFORMANCE)return g}else if(q())return g;var d="$jscomp_hidden_"+Math.random();a("freeze");a("preventExtensions");a("seal");var e=0,f=function(b){this.id_=(e+=Math.random()+1).toString();if(b){b=$jscomp.makeIterator(b);for(var c;!(c=b.next()).done;)c=c.value,this.set(c[0],c[1])}};f.prototype.set=function(b,c){l(b);if(!$jscomp.owns(b,d))throw Error("WeakMap key fail: "+b);b[d][this.id_]=c;return this};f.prototype.get=function(b){return $jscomp.owns(b,d)?b[d][this.id_]:void 0};f.prototype.has=
...
$jscomp.polyfill("Map",function(g){function q(){if($jscomp.ASSUME_NO_NATIVE_MAP||!g||"function"!=typeof g||!g.prototype.entries||"function"!=typeof Object.seal)return!1;try{var b=Object.seal({x:4}),c=new g($jscomp.makeIterator([[b,"s"]]));if("s"!=c.get(b)||1!=c.size||c.get({x:4})||c.set({x:4},"t")!=c||2!=c.size)return!1;var a=c.entries(),d=a.next();if(d.done||d.value[0]!=b||"s"!=d.value[1])return!1;d=a.next();return d.done||4!=d.value[0].x||"t"!=d.value[1]||!a.next().done?!1:!0}catch(m){return!1}}
if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(g&&$jscomp.ES6_CONFORMANCE)return g}else if(q())return g;$jscomp.initSymbolIterator();var h=new WeakMap,l=function(b){this.data_={};this.head_=e();this.size=0;if(b){b=$jscomp.makeIterator(b);for(var c;!(c=b.next()).done;)c=c.value,this.set(c[0],c[1])}};l.prototype.set=function(b,c){b=0===b?0:b;var k=a(this,b);k.list||(k.list=this.data_[k.id]=[]);k.entry?k.entry.value=c:(k.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:b,
value:c},k.list.push(k.entry),this.head_.previous.next=k.entry,this.head_.previous=k.entry,this.size++);return this};l.prototype.delete=function(b){b=a(this,b);return b.entry&&b.list?(b.list.splice(b.index,1),b.list.length||delete this.data_[b.id],b.entry.previous.next=b.entry.next,b.entry.next.previous=b.entry.previous,b.entry.head=null,this.size--,!0):!1};l.prototype.clear=function(){this.data_={};this.head_=this.head_.previous=e();this.size=0};l.prototype.has=function(b){return!!a(this,b).entry};
l.prototype.get=function(b){return(b=a(this,b).entry)&&b.value};l.prototype.entries=function(){return d(this,function(b){return[b.key,b.value]})};l.prototype.keys=function(){return d(this,function(b){return b.key})};l.prototype.values=function(){return d(this,function(b){return b.value})};l.prototype.forEach=function(b,c){for(var a=this.entries(),d;!(d=a.next()).done;)d=d.value,b.call(c,d[1],d[0],this)};l.prototype[Symbol.iterator]=l.prototype.entries;var a=function(b,c){var a=c&&typeof c;"object"==
a||"function"==a?h.has(c)?a=h.get(c):(a=""+ ++f,h.set(c,a)):a="p_"+c;var d=b.data_[a];if(d&&$jscomp.owns(b.data_,a))for(b=0;b<d.length;b++){var e=d[b];if(c!==c&&e.key!==e.key||c===e.key)return{id:a,list:d,index:b,entry:e}}return{id:a,list:d,index:-1,entry:void 0}},d=function(b,c){var a=b.head_;return $jscomp.iteratorPrototype(function(){if(a){for(;a.head!=b.head_;)a=a.previous;for(;a.next!=a.head;)return a=a.next,{done:!1,value:c(a)};a=null}return{done:!0,value:void 0}})},e=function(){var b={};return b.previous=
b.next=b.head=b},f=0;return l},"es6","es3");
...
$jscomp.polyfill("Object.entries",function(g){return g?g:function(g){var h=[],l;for(l in g)$jscomp.owns(g,l)&&h.push([l,g[l]]);return h}},"es8","es3");$jscomp.polyfill("Array.prototype.fill",function(g){return g?g:function(g,h,l){var a=this.length||0;0>h&&(h=Math.max(0,a+h));if(null==l||l>a)l=a;l=Number(l);0>l&&(l=Math.max(0,a+l));for(h=Number(h||0);h<l;h++)this[h]=g;return this}},"es6","es3");
$jscomp.assign="function"==typeof Object.assign?Object.assign:function(g,q){for(var h=1;h<arguments.length;h++){var l=arguments[h];if(l)for(var a in l)$jscomp.owns(l,a)&&(g[a]=l[a])}return g};$jscomp.polyfill("Object.assign",function(g){return g||$jscomp.assign},"es6","es3");
(function(){for(var g=document.getElementsByTagName("canvas"),q=0;q<g.length;q++)if(g[q].hasAttribute("coreGraphics")){var h=g[q];h.library=new function(){var l=this;this.math=new function(){this.averageArray=function(a){return a.reduce(function(a,e){return a+e},0)/a.length};this.averagePoint=function(a){var d=a.reduce(function(a,d){return{x:a.x+d.x,y:a.y+d.y}});return{x:d.x/a.length,y:d.y/a.length}};this.distanceBetweenTwoPoints=function(a,d){return Math.pow(Math.pow(a.x-d.x,2)+Math.pow(a.y-d.y,
...
return a};this.boundingBoxFromPoints=function(a){if(0==a.length)return{topLeft:{x:0,y:0},bottomRight:{x:0,y:0}};for(var d=a[0].x,e=a[0].x,f=a[0].y,b=a[0].y,c=1;c<a.length;c++)a[c].x<d?d=a[c].x:a[c].x>e&&(e=a[c].x),a[c].y<f?f=a[c].y:a[c].y>b&&(b=a[c].y);return{topLeft:{x:d,y:f},bottomRight:{x:e,y:b}}};this.pointsOfRect=function(a,d,e,f,b,c){b=void 0===b?0:b;c=void 0===c?{x:0,y:0}:c;var k=c.x*e,n=c.y*f,m=this.cartesian2polar(k,n);m=this.polar2cartesian(m.ang-b,m.dis);c={x:a-m.x,y:d-m.y};m=this.cartesian2polar(k-
e,n);m=this.polar2cartesian(m.ang-b,m.dis);var v={x:a-m.x,y:d-m.y};m=this.cartesian2polar(k-e,n-f);m=this.polar2cartesian(m.ang-b,m.dis);e={x:a-m.x,y:d-m.y};m=this.cartesian2polar(k,n-f);m=this.polar2cartesian(m.ang-b,m.dis);return[c,v,e,{x:a-m.x,y:d-m.y}]};this.pointsOfCircle=function(a,d,e,f){f=void 0===f?3:f;for(var b=[],c=0;c<f;c++)b.push({x:a+e*Math.sin(c/f*Math.PI*2),y:d+e*Math.cos(c/f*Math.PI*2)});return b};this.pointsOfText=function(a,d,e,f,b,c,k,n){var m=document.createElement("canvas").getContext("2d");
m.font=c;m.textAlign=k;m.textBaseline=n;a=m.measureText(a).width/b;c=-c.split("pt")[0].split(" ").pop();isNaN(c)&&(c=-7.5);c/=b;b=[{x:d,y:e},{x:d+a,y:e},{x:d+a,y:e-c},{x:d,y:e-c}];a={start:0,end:0,center:a/2,left:a,right:a};c={alphabetic:c,top:0,hanging:0,middle:c/2,ideographic:0,bottom:c};for(m=0;m<b.length;m++)b[m]={x:b[m].x-a[k],y:b[m].y+c[n]};for(m=0;m<b.length;m++)b[m]=this.cartesianAngleAdjust(b[m].x-d,b[m].y-e,f),b[m].x+=d,b[m].y+=e;return b};this.relativeDistance=function(a,d,e,f,b){d=(f-
...
d?0:d;e=void 0===e?1:e;f=void 0===f?8:f;return l.math.normalizeStretchArray([1/(1+Math.exp(-.5*-f)),1/(1+Math.exp(-f*((void 0===a?.5:a)-.5))),1/(1+Math.exp(.5*-f))])[1]*(e-d)+d};this.exponential=function(a,d,e,f){d=void 0===d?0:d;e=void 0===e?1:e;f=void 0===f?2:f;return l.math.normalizeStretchArray([(Math.exp(0*f)-1)/(Math.E-1),(Math.exp(f*(void 0===a?.5:a))-1)/(Math.E-1),(Math.exp(1*f)-1)/(Math.E-1)])[1]*(e-d)+d}};this.curveGenerator=new function(){this.linear=function(a,d,e){d=void 0===d?0:d;e=
...
d[e].boundingBox)&&this.overlappingPolygons(a.points,d[e].points))return!0;return!1}};this.fitPolyIn=function(a,d,e){e=void 0===e?!1:e;var f,b=[[],[],[]],c=h.library.math.averagePoint(a.points),k=100,n=[];for(f=1;f<k+1;f++){n=[];for(var m=2*f+1,v=2*Math.PI/m,A=Math.pow(f,2),w=0;w<m;w++){var z=l.math.polar2cartesian(v*w,A);e&&b[0].push({x:z.x+c.x,y:z.y+c.y});this.detectOverlap.overlappingPolygonWithPolygons(this.applyOffsetToPolygon(z,a),d)||n.push({ang:v*w,dis:A})}if(0!=n.length)break}k=10;if(1==
n.length)var g=n[0];else{m=Math.pow(f,2);v=Math.pow(f-1,2);A=[];for(f=0;f<k;f++){var p=[],r=(m-v)/2+v;for(w=0;w<n.length;w++)z=l.math.polar2cartesian(n[w].ang,r),e&&b[1].push({x:z.x+c.x,y:z.y+c.y}),this.detectOverlap.overlappingPolygonWithPolygons(this.applyOffsetToPolygon(z,a),d)||(p.push({ang:n[w].ang,dis:r}),A.push({ang:n[w].ang,dis:r}));if(1==p.length){g=p[0];break}0==p.length?v=r:m=r}void 0==g&&(g=A.pop())}k=10;f=l.math.polar2cartesian(g.ang,g.dis);e&&b[2].push({x:f.x+c.x,y:f.y+c.y});n=f.x;w=
f.y;for(f=g=z=0;f<k;f++)m=(n-z)/2+z,v=(w-g)/2+g,e&&b[2].push({x:m+c.x,y:w+c.y}),this.detectOverlap.overlappingPolygonWithPolygons(this.applyOffsetToPolygon({x:m,y:w},a),d)?z=m:n=m,e&&b[2].push({x:n+c.x,y:v+c.y}),this.detectOverlap.overlappingPolygonWithPolygons(this.applyOffsetToPolygon({x:n,y:v},a),d)?g=v:w=v;f={x:n,y:w};return e?{offset:f,paths:b}:f}};this.structure=new function(){this.functionListRunner=function(a,d){return function(e,f){for(var b=0;b<a.length;b++){for(var c=!0,k=0;k<a[b].requiredKeys.length;k++){c=
!0;for(var n=0;n<a[b].requiredKeys[k].length&&(c=c&&d[a[b].requiredKeys[k][n]],c);n++);if(c)break}if(c&&a[b].function(e,f))break}}};this.signalRegistry=function(a,d,e){a=void 0===a?-1:a;d=void 0===d?-1:d;e=void 0===e?-1:e;var f=[],b=[],c=[],k=[],n={},m=[];this.__dump=function(){console.log("---- signalRegistry dump ----");console.log("\tsignals");for(var b=0;b<f.length;b++)console.log("\t\t",b," "+JSON.stringify(f[b]));console.log("\tselectedSignals");for(b=0;b<tselectedSignals.length;b++)console.log("\t\t",
b," "+JSON.stringify(tselectedSignals[b]));console.log("\tevents");for(b=0;b<c.length;b++)console.log("\t\t",b," "+JSON.stringify(c[b]));console.log("\tevents_byID");for(b=0;b<k.length;b++)console.log("\t\t",b," "+JSON.stringify(k[b]));console.log("\tevents_byPosition");var a=Object.keys(n);for(b=0;b<a.length;b++)console.log("\t\t",a[b]," "+JSON.stringify(n[a[b]]));console.log("\tpositions");for(b=0;b<m.length;b++)console.log("\t\t",b," "+JSON.stringify(m[b]))};this.export=function(){return JSON.parse(JSON.stringify({signals:f,
selectedSignals:b,events:c,events_byID:k,events_byPosition:n,positions:m}))};this.import=function(a){f=JSON.parse(JSON.stringify(a.signals));b=JSON.parse(JSON.stringify(a.selectedSignals));c=JSON.parse(JSON.stringify(a.events));k=JSON.parse(JSON.stringify(a.events_byID));n=JSON.parse(JSON.stringify(a.events_byPosition));m=JSON.parse(JSON.stringify(a.positions))};this.getAllSignals=function(){return JSON.parse(JSON.stringify(f))};this.getAllEvents=function(){return JSON.parse(JSON.stringify(c))};this.getSignal=
function(b){if(void 0!=f[b])return JSON.parse(JSON.stringify(f[b]))};this.eventsBetween=function(b,a){for(var d=void 0==a?Array.from(new Set(m.filter(function(c){return c==b}))):Array.from(new Set(m.filter(function(c){return c>=b&&c<a}))),k=[],e=0;e<d.length;e++){d[e]=n[String(d[e])];for(var f=0;f<d[e].length;f++)k.push(c[d[e][f]])}return k.sort(function(b,c){return b.position<c.position?-1:b.position>c.position?1:0})};this.add=function(b,h){if(void 0!=b&&"line"in b&&"position"in b&&"length"in b){"strength"in
...
{signalID:v,line:b.line,position:b.position+b.length,strength:0}];for(h=0;void 0!=c[h];)h++;c[h]=b[0];k[v]=[h];void 0==n[b[0].position]?n[b[0].position]=[h]:n[b[0].position].push(h);for(m.push(b[0].position);void 0!=c[h];)h++;c[h]=b[1];k[v]=k[v].concat(h);void 0==n[b[1].position]?n[b[1].position]=[h]:n[b[1].position].push(h);m.push(b[1].position);return v}};this.remove=function(b){if(void 0!=f[b]){delete f[b];for(var a=0;a<k[b].length;a++){var d=k[b][a];n[c[d].position].splice(n[c[d].position].indexOf(d),
1);m.splice(m.indexOf(c[d].position),1);0==n[c[d].position].length&&delete n[c[d].position];delete c[d]}delete k[b]}};this.update=function(b,c){void 0!=c&&("line"in c||(c.line=f[b].line),-1<a&&("position"in c&&"length"in c?c.length+c.position>a&&(c.length=a-c.position):("position"in c?f[b].length+c.position>=a&&(c.position=a-f[b].length):c.position=f[b].position,"length"in c?c.length+c.position>a&&(c.length=a-c.position):c.length=f[b].length)),"strength"in c||(c.strength=f[b].strength),this.remove(b),
this.add(c,b))};this.reset=function(){f=[];b=[];c=[];k=[];n={};m=[]}}};this.audio=new function(){this.context=new (window.AudioContext||window.webkitAudioContext);this.changeAudioParam=function(b,c,a,d,e,f){f=void 0===f?!0:f;if(null==a)return c.value;f&&c.cancelScheduledValues(b.currentTime);try{switch(e){case "linear":c.linearRampToValueAtTime(a,b.currentTime+d);break;case "exponential":console.warn("2018-4-18 - changeAudioParam:exponential doesn't work on chrome");0==a&&(a=1E-4);c.exponentialRampToValueAtTime(a,
b.currentTime+d);break;case "s":for(var k=a-c.value,m=l.math.curveGenerator.s(10),n=0;n<m.length;n++)m[n]=c.value+m[n]*k;c.setValueCurveAtTime(new Float32Array(m),b.currentTime,d);break;default:c.setTargetAtTime(a,b.currentTime,.001)}}catch(u){console.log("could not change param (possibly due to an overlap, or bad target value)"),console.log("audioParam:",c,"target:",a,"time:",d,"curve:",e,"cancelScheduledValues:",f),console.log(u)}};this.loadAudioFile=function(b,c,a){a=void 0===a?"":a;switch(void 0===
c?"file":c){case "url":c=new XMLHttpRequest;c.open("GET",a,!0);c.responseType="arraybuffer";c.onload=function(){l.audio.context.decodeAudioData(this.response,function(c){b({buffer:c,name:a.split("/").pop(),duration:c.duration})},function(b){console.warn("Error with decoding audio data"+b.err)})};c.send();break;default:var d=document.createElement("input");d.type="file";d.onchange=function(){var c=this.files[0],a=new FileReader;a.readAsArrayBuffer(c);a.onload=function(a){l.audio.context.decodeAudioData(a.target.result,
function(a){b({buffer:a,name:c.name,duration:a.duration})});d.remove()}};document.body.appendChild(d);d.click()}};this.waveformSegment=function(b,c,a){c=void 0===c?{start:0,end:1}:c;a=void 0===a?1E4:a;var d=b.getChannelData(0);c.start=c.start?c.start:0;c.end=c.end?c.end:1;var k=b.length*c.start;b=b.length*c.end;a=(b-k)/a;for(c=[];k<b;k+=Math.round(a))c.push(l.math.largestValueFound(d.slice(k,k+Math.round(a))));return c};this.loadBuffer=function(b,c,a,d){b=b.createBufferSource();b.buffer=c;b.connect(a);
b.onended=d;return b};this.destination=this.context.createGain();this.destination.connect(this.context.destination);this.destination._gain=1;this.destination.masterGain=function(b){if(void 0==b)return this.destination._gain;this._gain=b;l.audio.changeAudioParam(l.audio.context,this.gain,this._gain,.01,"instant",!0)};this.names_frequencies_split={0:{C:16.35,"C#":17.32,D:18.35,"D#":19.45,E:20.6,F:21.83,"F#":23.12,G:24.5,"G#":25.96,A:27.5,"A#":29.14,B:30.87},1:{C:32.7,"C#":34.65,D:36.71,"D#":38.89,E:41.2,
...
32,function(b){b=a.charAt(b);if(!d["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$"]){d["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$"]={};for(var c=0;65>c;c++)d["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$"]["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$".charAt(c)]=c}return d["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$"][b]})},_compress:function(a,b,c){if(null==a)return"";var d,e={},m={},f="",
h=2,g=3,l=2,u=[],p=0,r=0,q;for(q=0;q<a.length;q+=1){var x=a.charAt(q);Object.prototype.hasOwnProperty.call(e,x)||(e[x]=g++,m[x]=!0);var y=f+x;if(Object.prototype.hasOwnProperty.call(e,y))f=y;else{if(Object.prototype.hasOwnProperty.call(m,f)){if(256>f.charCodeAt(0)){for(d=0;d<l;d++)p<<=1,r==b-1?(r=0,u.push(c(p)),p=0):r++;var t=f.charCodeAt(0);for(d=0;8>d;d++)p=p<<1|t&1,r==b-1?(r=0,u.push(c(p)),p=0):r++,t>>=1}else{t=1;for(d=0;d<l;d++)p=p<<1|t,r==b-1?(r=0,u.push(c(p)),p=0):r++,t=0;t=f.charCodeAt(0);
for(d=0;16>d;d++)p=p<<1|t&1,r==b-1?(r=0,u.push(c(p)),p=0):r++,t>>=1}h--;0==h&&(h=Math.pow(2,l),l++);delete m[f]}else for(t=e[f],d=0;d<l;d++)p=p<<1|t&1,r==b-1?(r=0,u.push(c(p)),p=0):r++,t>>=1;h--;0==h&&(h=Math.pow(2,l),l++);e[y]=g++;f=String(x)}}if(""!==f){if(Object.prototype.hasOwnProperty.call(m,f)){if(256>f.charCodeAt(0)){for(d=0;d<l;d++)p<<=1,r==b-1?(r=0,u.push(c(p)),p=0):r++;t=f.charCodeAt(0);for(d=0;8>d;d++)p=p<<1|t&1,r==b-1?(r=0,u.push(c(p)),p=0):r++,t>>=1}else{t=1;for(d=0;d<l;d++)p=p<<1|t,
r==b-1?(r=0,u.push(c(p)),p=0):r++,t=0;t=f.charCodeAt(0);for(d=0;16>d;d++)p=p<<1|t&1,r==b-1?(r=0,u.push(c(p)),p=0):r++,t>>=1}h--;0==h&&(h=Math.pow(2,l),l++);delete m[f]}else for(t=e[f],d=0;d<l;d++)p=p<<1|t&1,r==b-1?(r=0,u.push(c(p)),p=0):r++,t>>=1;h--;0==h&&l++}t=2;for(d=0;d<l;d++)p=p<<1|t&1,r==b-1?(r=0,u.push(c(p)),p=0):r++,t>>=1;for(;;)if(p<<=1,r==b-1){u.push(c(p));break}else r++;return u.join("")},_decompress:function(d,b,c){var k=[],e=4,m=4,f=3,h=[],l,g,u=c(0),p=b,r=1;for(l=0;3>l;l+=1)k[l]=l;var q=
0;var x=Math.pow(2,2);for(g=1;g!=x;){var y=u&p;p>>=1;0==p&&(p=b,u=c(r++));q|=(0<y?1:0)*g;g<<=1}switch(q){case 0:q=0;x=Math.pow(2,8);for(g=1;g!=x;)y=u&p,p>>=1,0==p&&(p=b,u=c(r++)),q|=(0<y?1:0)*g,g<<=1;var t=a(q);break;case 1:q=0;x=Math.pow(2,16);for(g=1;g!=x;)y=u&p,p>>=1,0==p&&(p=b,u=c(r++)),q|=(0<y?1:0)*g,g<<=1;t=a(q);break;case 2:return""}l=k[3]=t;for(h.push(t);;){if(r>d)return"";q=0;x=Math.pow(2,f);for(g=1;g!=x;)y=u&p,p>>=1,0==p&&(p=b,u=c(r++)),q|=(0<y?1:0)*g,g<<=1;switch(t=q){case 0:q=0;x=Math.pow(2,
8);for(g=1;g!=x;)y=u&p,p>>=1,0==p&&(p=b,u=c(r++)),q|=(0<y?1:0)*g,g<<=1;k[m++]=a(q);t=m-1;e--;break;case 1:q=0;x=Math.pow(2,16);for(g=1;g!=x;)y=u&p,p>>=1,0==p&&(p=b,u=c(r++)),q|=(0<y?1:0)*g,g<<=1;k[m++]=a(q);t=m-1;e--;break;case 2:return h.join("")}0==e&&(e=Math.pow(2,f),f++);if(k[t])t=k[t];else if(t===m)t=l+l.charAt(0);else return null;h.push(t);k[m++]=l+t.charAt(0);e--;l=t;0==e&&(e=Math.pow(2,f),f++)}}};return e}()}};h.core=new function(){var g=new function(){function a(b){for(var c=[];void 0!=(b=
b.parent);)c.unshift({x:b.x,y:b.y,a:b.angle});b={x:void 0!=c[0]?c[0].x:0,y:void 0!=c[0]?c[0].y:0,a:void 0!=c[0]?c[0].a:0};for(var a=1;a<c.length;a++){var d=h.library.math.cartesianAngleAdjust(c[a].x,c[a].y,c[a-1].a);b.a+=c[a].a;b.x+=d.x;b.y+=d.y}return b}var d=this,e=new function(){this.length=function(b){return b*d.viewport.scale()};this.windowPoint2coreGraphicsPoint=function(b,c){var a=d.viewport.position(),e=d.viewport.scale()/window.devicePixelRatio,m=d.viewport.angle();b=b/e-a.x;c=c/e-a.y;return h.library.math.cartesianAngleAdjust(b,
c,-m)};this.coreGraphicsPoint2windowPoint=function(b,c){var a=d.viewport.position(),e=d.viewport.scale(),m=d.viewport.angle();b=h.library.math.cartesianAngleAdjust(b,c,m);return{x:(b.x+a.x)*e,y:(b.y+a.y)*e}}},f=new function(){this.polygon=function(){this.type="polygon";this.name="";this._static=this.ignored=!1;this.parent=void 0;this.dotFrame=!1;this.extremities={points:[],boundingBox:{}};this.points=[];this.style={fill:"rgba(100,255,255,1)",stroke:"rgba(0,0,0,0)",lineWidth:1,lineJoin:"round",miterLimit:2};
...
y:c},this.extremities.boundingBox);return a?(void 0==this.extremities.points?(console.warn("the shape",this,"has no points"),b=!1):b=h.library.math.detectOverlap.pointWithinPoly({x:b,y:c},this.extremities.points),b):!1};this.render=function(c,a,k){a=void 0===a?{x:0,y:0,a:0}:a;k=void 0===k?!1:k;var f=this._static?!0:h.library.math.detectOverlap.boundingBoxes(d.viewport.getBoundingBox(),this.extremities.boundingBox);if(f){f=h.library.math.cartesianAngleAdjust(this.x,this.y,a.a);a.x+=f.x-this.x;a.y+=
f.y-this.y;f={x:this.x+a.x,y:this.y+a.y};a=this.angle+a.a;var m=this.width,n=this.height;k||(f=e.coreGraphicsPoint2windowPoint(f.x-this.anchor.x*m,f.y-this.anchor.y*n),m=e.length(m),n=e.length(n));f=h.library.math.cartesianAngleAdjust(f.x,f.y,-a);c.save();c.rotate(a);c.drawImage(b,f.x,f.y,m,n);c.restore();if(this.dotFrame){for(c=0;c<this.extremities.points.length;c++)k=e.coreGraphicsPoint2windowPoint(this.extremities.points[c].x,this.extremities.points[c].y),d.render.drawDot(k.x,k.y,4,"rgba(50,50,50,1)");
...
a.a;var g=this.width,n=this.height,l=this.style.lineWidth;a={x:this.x+a.x-this.anchor.x*(this.width*Math.cos(c)+this.height*Math.sin(-c)),y:this.y+a.y-this.anchor.y*(this.width*Math.sin(c)+this.height*Math.cos(-c))};k||(a=e.coreGraphicsPoint2windowPoint(a.x,a.y),g=e.length(g),n=e.length(n),l=e.length(l));a=h.library.math.cartesianAngleAdjust(a.x,a.y,-c);if(f)b.rotate(c),k=new Path2D,k.rect(a.x,a.y,g,n),b.clip(k),b.rotate(-c);else if(b.fillStyle=this.style.fill,b.strokeStyle=this.style.stroke,b.lineWidth=
l,b.save(),b.rotate(c),b.fillRect(a.x,a.y,g,n),b.strokeRect(a.x,a.y,g,n),b.restore(),this.dotFrame){for(b=0;b<this.extremities.points.length;b++)k=e.coreGraphicsPoint2windowPoint(this.extremities.points[b].x,this.extremities.points[b].y),d.render.drawDot(k.x,k.y,4,"rgba(50,50,50,1)");k=e.coreGraphicsPoint2windowPoint(this.extremities.boundingBox.topLeft.x,this.extremities.boundingBox.topLeft.y);d.render.drawDot(k.x,k.y);k=e.coreGraphicsPoint2windowPoint(this.extremities.boundingBox.bottomRight.x,
...
group:0,image:0,path:0,polygon:0,rectangle:0,text:0}};this.collect=function(b){a&&e.compute(b)};this.active=function(b){if(void 0==b)return a;a=b};this.getReport=function(){f.recursiveCount();return{framesPerSecond:e.rate,shapeCount:f.counts}}};this.callback=new function(){for(var a="onmousedown onmouseup onmousemove onmouseenter onmouseleave onwheel onclick ondblclick onkeydown onkeyup touchstart touchmove touchend touchenter touchleave touchcancel".split(" "),c={},f=0;f<a.length;c={$jscomp$loop$prop$getRelevantShape$7:c.$jscomp$loop$prop$getRelevantShape$7},
f++){c.$jscomp$loop$prop$getRelevantShape$7=function(a,b,c){var e=d.arrangement.getElementUnderPoint(a,b);if(void 0!=e&&void 0==e[c])for(a=d.arrangement.getElementUnderPoint(a,b,void 0,!0),b=0;b<a.length;b++)if(void 0!=a[b][c]){e=a[b];break}return e};this[a[f]]=function(a,b,d){};var g=0,l=0;h[a[f]]=function(a){return function(b){return function(c){if(d.callback[b]){var f=e.windowPoint2coreGraphicsPoint(c.x,c.y),g=a.$jscomp$loop$prop$getRelevantShape$7(f.x,f.y,b);d.callback[b](f.x,f.y,c,g)}}}}(c)(a[f]);
h.onmouseover=function(a){return function(b){d.viewport.stopMouseScroll()&&(document.body.style.overflow="hidden");if(d.callback.onmouseover){var c=e.windowPoint2coreGraphicsPoint(b.x,b.y),f=a.$jscomp$loop$prop$getRelevantShape$7(c.x,c.y,"onmouseover");d.callback.onmouseover(c.x,c.y,b,f)}}}(c);h.onmouseout=function(a){return function(b){d.viewport.stopMouseScroll()&&(document.body.style.overflow="");if(d.callback.onmouseout){var c=e.windowPoint2coreGraphicsPoint(b.x,b.y),f=a.$jscomp$loop$prop$getRelevantShape$7(c.x,
c.y,"onmouseout");d.callback.onmouseout(c.x,c.y,b,f)}}}(c);h.onmousemove=function(a){return function(b){var c=e.windowPoint2coreGraphicsPoint(b.x,b.y);d.viewport.mousePosition(c.x,c.y);if(d.callback.onmousemove){var f=a.$jscomp$loop$prop$getRelevantShape$7(g,l,"onmouseleave"),h=a.$jscomp$loop$prop$getRelevantShape$7(c.x,c.y,"onmouseenter"),k=a.$jscomp$loop$prop$getRelevantShape$7(c.x,c.y,"onmousemove");f!=h&&(d.callback.onmouseleave(c.x,c.y,b,f),d.callback.onmouseenter(c.x,c.y,b,h));d.callback.onmousemove(c.x,
c.y,b,k);g=c.x;l=c.y}}}(c);h.onkeydown=function(a){return function(b){if(d.callback.onkeydown){var c=d.viewport.mousePosition(),e=a.$jscomp$loop$prop$getRelevantShape$7(c.x,c.y,"onkeydown");d.callback.onkeydown(c.x,c.y,b,e)}}}(c);h.onkeyup=function(a){return function(b){if(d.callback.onkeyup){var c=d.viewport.mousePosition(),e=a.$jscomp$loop$prop$getRelevantShape$7(c.x,c.y,"onkeyup");d.callback.onkeyup(c.x,c.y,b,e)}}}(c)}};d.viewport.refresh();d.arrangement.clear()};this.arrangement=new function(){this.get=
function(){return g.arrangement.get()};this.set=function(a){return g.arrangement.set(a)};this.createElement=function(a){return g.arrangement.createElement(a)};this.append=function(a){return g.arrangement.append(a)};this.prepend=function(a){return g.arrangement.prepend(a)};this.remove=function(a){return g.arrangement.remove(a)};this.getElementUnderPoint=function(a,d){return g.arrangement.getElementUnderPoint(a,d)};this.getElementsWithName=function(a){return g.arrangement.getElementsWithName(a)};this.forceRefresh=
function(a){return g.arrangement.forceRefresh(a)}};this.viewport=new function(){this.position=function(a,d){return g.viewport.position(a,d)};this.scale=function(a){return g.viewport.scale(a)};this.angle=function(a){return g.viewport.angle(a)};this.windowPoint2coreGraphicsPoint=function(a,d){return g.viewport.windowPoint2coreGraphicsPoint(a,d)};this.refresh=function(){g.viewport.refresh()};this.mousePosition=function(){return g.viewport.mousePosition()};this.stopMouseScroll=function(a){return g.viewport.stopMouseScroll(a)};
this.allowKeyboardInput=function(a){return g.viewport.allowKeyboardInput(a)};this.cursor=function(a){return g.viewport.cursor(a)}};this.render=new function(){this.clearColour=function(a){return g.render.clearColour(a)};this.frame=function(a){return g.render.frame(void 0===a?!1:a)};this.active=function(a){return g.render.active(a)}};this.stats=new function(){this.active=function(a){return g.stats.active(a)};this.getReport=function(){return g.stats.getReport()}};this.callback=new function(){this.onmousedown=
function(a,d,e,f){};g.callback.onmousedown=function(a){return function(d,e,f,b){a.onmousedown(d,e,f,b)}}(this);this.onmouseup=function(a,d,e,f){};g.callback.onmouseup=function(a){return function(d,e,f,b){a.onmouseup(d,e,f,b)}}(this);this.onmousemove=function(a,d,e,f){};g.callback.onmousemove=function(a){return function(d,e,f,b){a.onmousemove(d,e,f,b)}}(this);this.onmouseenter=function(a,d,e,f){};g.callback.onmouseenter=function(a){return function(d,e,f,b){a.onmouseenter(d,e,f,b)}}(this);this.onmouseleave=
function(a,d,e,f){};g.callback.onmouseleave=function(a){return function(d,e,f,b){a.onmouseleave(d,e,f,b)}}(this);this.onwheel=function(a,d,e,f){};g.callback.onwheel=function(a){return function(d,e,f,b){a.onwheel(d,e,f,b)}}(this);this.onclick=function(a,d,e,f){};g.callback.onclick=function(a){return function(d,e,f,b){a.onclick(d,e,f,b)}}(this);this.ondblclick=function(a,d,e,f){};g.callback.ondblclick=function(a){return function(d,e,f,b){a.ondblclick(d,e,f,b)}}(this);this.onkeydown=function(a,d,e,f){};
g.callback.onkeydown=function(a){return function(d,e,f,b){a.onkeydown(d,e,f,b)}}(this);this.onkeyup=function(a,d,e,f){};g.callback.onkeyup=function(a){return function(d,e,f,b){a.onkeyup(d,e,f,b)}}(this);this.touchstart=function(a,d,e){};g.callback.touchstart=function(a){return function(d,e,f,b){a.touchstart(d,e,f)}}(this);this.touchmove=function(a,d,e){};g.callback.touchmove=function(a){return function(d,e,f,b){a.touchmove(d,e,f)}}(this);this.touchend=function(a,d,e){};g.callback.touchend=function(a){return function(d,
e,f,b){a.touchend(d,e,f)}}(this);this.touchenter=function(a,d,e){};g.callback.touchenter=function(a){return function(d,e,f,b){a.touchenter(d,e,f)}}(this);this.touchleave=function(a,d,e){};g.callback.touchleave=function(a){return function(d,e,f,b){a.touchleave(d,e,f)}}(this);this.touchcancel=function(a,d,e){};g.callback.touchcancel=function(a){return function(d,e,f,b){a.touchcancel(d,e,f)}}(this)}}}})();

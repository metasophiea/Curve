...
//create objects
    ...
    //test objects (and floating labels)
        ...
        var testObject_oneShotStudio_multi_1 = objects.testObject_oneShotStudio_multi(400,315);
        __globals.panes.middleground.append( testObject_oneShotStudio_multi_1 );
        __globals.panes.background.append( __globals.utility.experimental.elementMaker('label','',{x:640, y:347.5, text:'oneShotStudio_multi'}) );

    //connections
        testObject_oneShotStudio_multi_1.io.outRight.connectTo( audioDuplicator_1.io.input );
        testObject_oneShotStudio_multi_1.io.outLeft.connectTo( audioDuplicator_2.io.input );

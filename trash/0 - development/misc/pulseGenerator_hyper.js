this.pulseGenerator_hyper = function(name,x,y,a){
    var maxTempo = 999;
...
this.pulseGenerator_hyper.metadata = {
    name:'Pulse Generator ::Old (Hyper)',
    category:'misc',
...
this.pulseGenerator_signal_hyper = function(name,x,y,a){
    var maxTempo = 999;
    ...
    var design = {
        name:name,
        model:'pulseGenerator_signal_hyper',
        category:'misc',
        collection:'alpha',
        x:x, y:y, a:a,
        space:[
...
this.pulseGenerator_signal_hyper.metadata = {
    name:'Pulse Generator (Hyper) ::Signal',
    category:'misc',
    dev:true,
    helpURL:'https://curve.metasophiea.com/help/objectects/alpha/pulseGenerator/'
};

this.pulseGenerator_voltage_hyper = function(name,x,y,a){
    var maxTempo = 999;
    ...
    var design = {
        name:name,
        model:'pulseGenerator_voltage_hyper',
        category:'misc',
        collection:'alpha',
        x:x, y:y, a:a,
        space:[
...
this.pulseGenerator_voltage_hyper.metadata = {
    name:'Pulse Generator (Hyper) ::Voltage',
    category:'misc',
    dev:true,
    helpURL:'https://curve.metasophiea.com/help/objectects/alpha/pulseGenerator/'
};

this.pulseGenerator_data_hyper = function(name,x,y,a){
    var maxTempo = 999;
    ...
    var design = {
        name:name,
        model:'pulseGenerator_data_hyper',
        category:'misc',
        collection:'alpha',
        x:x, y:y, a:a,
        space:[
...
this.pulseGenerator_data_hyper.metadata = {
    name:'Pulse Generator (Hyper) ::Data',
    category:'misc',
    dev:true,
    helpURL:'https://curve.metasophiea.com/help/objectects/alpha/pulseGenerator/'
};
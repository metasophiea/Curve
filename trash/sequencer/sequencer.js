var sequencer = function(
    ...
    //internal functions
        ...
        function makeNote(line, position, length, strength=1){
            ...
            var newNoteBlock = part.element.control.sequencer.noteBlock(newID, width/(xCount*zoomLevel_x), height/(yCount*zoomLevel_y), approvedData.line, approvedData.position, approvedData.length, false, blockStyle_body, blockStyle_bodyGlow, blockStyle_handle, blockStyle_handleWidth);

...
//         system.utility.workspace.placeAndReturnObject( objects.audio_duplicator(50,50) );
//         system.utility.workspace.placeAndReturnObject( objects.audio_duplicator(200,50) );
...
//                 {objectConstructorName:"audio_duplicator", position:{x:200, y:50, s:1, r:0}, connections:[]}
//             ],
//             constructorFunctions:{ audio_duplicator:objects.audio_duplicator }
//         } );

...
var tmp = _canvas_.core.shape.create('rectangle');
    tmp.name = 'characterString_calcModeTest_0_backing';
    tmp.x(350); tmp.y(310);
    tmp.width(20);
    tmp.height(50);
    tmp.colour = {r:Math.random(),g:Math.random(),b:Math.random(),a:1};
    _canvas_.core.arrangement.append(tmp);
var tmp = _canvas_.core.shape.create('characterString');
    tmp.name = 'characterString_calcModeTest_0';
    tmp.string('Hello!');
    tmp.x(350); tmp.y(310);
    tmp.width(20);
    tmp.height(50);
    tmp.colour({r:Math.random(),g:Math.random(),b:Math.random(),a:1});
    tmp.calculationMode(0);
    _canvas_.core.arrangement.append(tmp);
var tmp = _canvas_.core.shape.create('rectangle');
    tmp.name = 'characterString_calcModeTest_1_backing';
    tmp.x(350); tmp.y(360);
    tmp.width(20);
    tmp.height(50);
    tmp.colour = {r:Math.random(),g:Math.random(),b:Math.random(),a:1};
    _canvas_.core.arrangement.append(tmp);
var tmp = _canvas_.core.shape.create('characterString');
    tmp.name = 'characterString_calcModeTest_1';
    tmp.string('Hello!');
    tmp.x(350); tmp.y(360);
    tmp.width(20);
    tmp.height(50);
    ...
    _canvas_.core.arrangement.append(tmp);
var tmp = _canvas_.core.shape.create('rectangle');
    tmp.name = 'characterString_calcModeTest_2_backing';
    tmp.x(350); tmp.y(410);
    tmp.width(20);
    tmp.height(50);
    tmp.colour = {r:Math.random(),g:Math.random(),b:Math.random(),a:1};
    _canvas_.core.arrangement.append(tmp);
var tmp = _canvas_.core.shape.create('characterString');
    tmp.name = 'characterString_calcModeTest_2';
    tmp.string('Hello!');
    tmp.x(350); tmp.y(410);
    tmp.width(20);
    tmp.height(50);
    tmp.colour({r:Math.random(),g:Math.random(),b:Math.random(),a:1});
    tmp.calculationMode(2);
    _canvas_.core.arrangement.append(tmp);
var tmp = _canvas_.core.shape.create('rectangle');
    tmp.name = 'characterString_calcModeTest_3_backing';
    tmp.x(350); tmp.y(460);
    tmp.width(20);
    tmp.height(50);
    tmp.colour = {r:Math.random(),g:Math.random(),b:Math.random(),a:1};
    _canvas_.core.arrangement.append(tmp);
var tmp = _canvas_.core.shape.create('characterString');
    tmp.name = 'characterString_calcModeTest_3';
    tmp.x(350); tmp.y(460);
    tmp.width(20);
    tmp.height(50);
    tmp.colour({r:Math.random(),g:Math.random(),b:Math.random(),a:1});
    tmp.calculationMode(3);
    tmp.string('Hello!');
    _canvas_.core.arrangement.append(tmp);

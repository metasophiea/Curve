...
//                     return function(value){
//                         vars.Q[a] = value;
//                         obj.filterCircuit_0.Q(a, system.utility.math.curvePoint.exponential(vars.Q[a],0,20000,10.5866095));
//                         obj.filterCircuit_1.Q(a, system.utility.math.curvePoint.exponential(vars.Q[a],0,20000,10.5866095));
//                         updateGraph(a);
//                     }
//                 }(a)
//             }},
...
//                         design.readout_sixteenSegmentDisplay['frequencyReadout_'+a].text( system.utility.misc.padString( system.utility.math.curvePoint.exponential(value,0,20000,10.5866095).toFixed(2), 8) );
//                         design.readout_sixteenSegmentDisplay['frequencyReadout_'+a].print('smart');
//                         obj.filterCircuit_0.frequency(a, system.utility.math.curvePoint.exponential(vars.frequency[a],0,20000,10.5866095));
//                         obj.filterCircuit_1.frequency(a, system.utility.math.curvePoint.exponential(vars.frequency[a],0,20000,10.5866095));
//                         updateGraph(a);
//                     }
//                 }(a)
//             }},
...
//     //circuitry
//         obj.filterCircuit_0 = new parts.circuits.audio.multibandFilter(system.audio.context,vars.channelCount);
//         obj.filterCircuit_1 = new parts.circuits.audio.multibandFilter(system.audio.context,vars.channelCount);

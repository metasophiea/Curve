part.circuit.audio.multibandFilter = function(
    ...
    //filterNodes
        for(var a = 0; a < bandcount; a++){
            ...
            system.utility.audio.changeAudioParam(context, temp.filterNode.frequency,110,0.01,'instant',true);
            system.utility.audio.changeAudioParam(context, temp.filterNode.Q,0.1,0.01,'instant',true);
            system.utility.audio.changeAudioParam(context, temp.gainNode.gain, temp.gain, 0.01, 'instant', true);
    ...
    //controls
        ...
        this.gain = function(band, value){
            ...
            system.utility.audio.changeAudioParam(context, flow.filterNodes[band].gainNode.gain, flow.filterNodes[band].gain, 0.01, 'instant', true);
        };
        this.frequency = function(band, value){
            ...
            system.utility.audio.changeAudioParam(context, flow.filterNodes[band].filterNode.frequency,flow.filterNodes[band].frequency,0.01,'instant',true);
        };
        this.Q = function(band, value){ 
            if(value == undefined){return flow.filterNodes[band].Q;}
            flow.filterNodes[band].Q = value;
            system.utility.audio.changeAudioParam(context, flow.filterNodes[band].filterNode.Q,value,0.01,'instant',true);
        };

this['test_c'] = function(name,x,y,angle){
    //main object creation
        const object = _canvas_.interface.unit.builder({
            ...
            elements:[
                {collection:'dynamic', type:'connectionNode_audio_2', name:'input_1', data:{ 
                    x:100, y:40, width:5, height:15, angle:0, isAudioOutput:false, cableVersion:2, style:style.connectionNode.audio
                }},
                {collection:'dynamic', type:'connectionNode_audio_2', name:'output', data:{ 
    ...
    //wiring
        ...
        //keycapture
        //io
            object.io.audio2.input_1.audioNode = N;
            object.io.audio2.output.audioNode = N;

...
var timeout = setTimeout(function(){
    ...
    //blocking screen
        system.pane.control.append(parts.basic.rect(null, 0, 0, viewportDimensions.width, viewportDimensions.height, 0, 'fill:rgba(255,255,255,0.9)'));
    //explanation text
        var text = system.utility.misc.elementMaker('text','explanation',{
            x:10, y:30, 
    ...
    //activation button
        system.pane.control.append(system.utility.misc.elementMaker('button_rect','audioOn',{
    ...
    //button text
        system.pane.control.append(system.utility.misc.elementMaker('text','explanation',{

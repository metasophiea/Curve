__globals.audio.context.resume().then(function(){
    __globals.panes.control.innerHTML = '';
...
var timeout = setTimeout(function(){
    ...
    //blocking screen
        __globals.panes.control.append(parts.basic.rect(null, 0, 0, viewportDimensions.width, viewportDimensions.height, 0, 'fill:rgba(255,255,255,0.9)'));
    //explanation text
        ...
        __globals.panes.control.append(text);
    ...
    //activation button
        __globals.panes.control.append(__globals.utility.misc.elementMaker('button_rect','audioOn',{
    ...
    //button text
        __globals.panes.control.append(__globals.utility.misc.elementMaker('text','explanation',{

// utility functions
    system.mouse = {};
    system.mouse.currentPosition = [];
    system.mouse.wheelInterpreter = function(y){
        return y/100;
        // return y > 0 ? 1 : -1;
    };
...
// grapple functions
    system.mouse.objectGrapple_functionList = {};
    system.mouse.objectGrapple_functionList.onmousedown = [];
    system.mouse.objectGrapple_functionList.onmouseup = [];
    system.mouse.declareObjectGrapple = function(grapple, target, creatorMethod){
    ...
    //duplication
    system.mouse.objectGrapple_functionList.onmousedown.push(
        {
    ...
    //selection
    system.mouse.objectGrapple_functionList.onmouseup.push(
        {
            'specialKeys':[],
            'function':function(event){
...
// onmousemove functions
    system.mouse.onmousemove_functionList = [];
    system.svgElement.onmousemove = function(event){
        //menu
        //workspace
    ...
    // register position
    system.mouse.onmousemove_functionList.push(
        {
            'specialKeys':[],
            'function':function(event){
...
// onmousedown functions
    system.mouse.onmousedown_functionList = [];
    ...
    //group selection
    system.mouse.onmousedown_functionList.push(
        {
...
// onwheel functions
    system.mouse.onwheel_functionList = [];
    ...
    system.mouse.onwheel_functionList.push(
        {
            'specialKeys':[],
            'function':function(event){

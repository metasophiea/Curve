...
impl Group {
    ...
    //attributes
        //pertinent to extremity calculation
            //heed_camera
                ...
                pub fn set_heed_camera(&mut self, new:Option<bool>) { self.heed_camera = new; self.compute_extremities(true, None, None); }
            //unified attribute
    ...
    //clipping
        pub fn stencil(&mut self, em:&ElementManager, element:usize) {
            ...
            self.compute_extremities(true, None, Some(self.cached_heed_camera));
        }
        ...
        //extremities
            fn compute_extremities(&mut self, inform_parent:bool, offset:Option<&Offset>, heed_camera:Option<bool>) {
                ...
                //determine heed_camera
                    self.cached_heed_camera = match heed_camera {
                        None => self.heed_camera.unwrap_or( self.cached_heed_camera ),
                        Some(heed_camera_arg) => self.heed_camera.unwrap_or( heed_camera_arg ),
                    };

    ...
    //attributes
        //pertinent to extremity calculation
            //width
                ...
                pub fn set_width(&mut self, new:f32) { self.width = new; self.compute_extremities(true, None, None); }
            //height
                pub fn get_height(&self) -> &f32 { &self.height }
                pub fn set_height(&mut self, new:f32) { self.height = new; self.compute_extremities(true, None, None); }
            //anchor
                pub fn get_anchor(&self) -> &Point { &self.anchor }
                pub fn set_anchor(&mut self, new:Point) { self.anchor = new; self.compute_extremities(true, None, None); }
        //other

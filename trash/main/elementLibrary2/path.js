this.path = function(_name){
    const type = 'path';
    dev.log.elementLibrary[type](' - new path(',_name); //#development
    ...
    this.looping = function(bool){
        ...
        dev.log.elementLibrary[type]('[',this.getAddress()+'].looping(',bool); //#development
    ...
    this.capType = function(type){
        ...
        dev.log.elementLibrary[type]('[',this.getAddress()+'].capType(',type); //#development

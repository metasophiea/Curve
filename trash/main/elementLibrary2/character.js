this.character = function(_name){
    ...
    dev.log.elementLibrary[type](' - new character(',_name); //#development
    ...
    this.character = function(character){
        ...
        dev.log.elementLibrary[type]('[',this.getAddress()+'].character)',character); //#development
    ...
    this.attachCallback = function(callbackType, callback){
        dev.log.elementLibrary('[',this.getAddress()+'] - character.attachCallback)',callbackType,callback); //#development
    ...
    this.removeCallback = function(callbackType){
        dev.log.elementLibrary('[',this.getAddress()+'] - character.removeCallback)',callbackType); //#development

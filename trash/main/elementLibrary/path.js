this.path = function(_id,_name){
    ...
    this.looping = function(bool,useCache=useCache_default){
        ...
        if(useCache && bool == undefined){ return cashedAttributes.looping; } cashedAttributes.looping = bool;
    ...
    this.capType = function(type,useCache=useCache_default){
        ...
        if(useCache && type == undefined){ return cashedAttributes.capType; } cashedAttributes.capType = type;

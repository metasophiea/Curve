this.filterUnit = function(x,y){
    ...
    //main object
        var object = canvas.object.builder(this.filterUnit,design);
    ...
    //circuitry
        //filter
            object.filterCircuit = new canvas.part.circuit.audio.filterUnit(canvas.library.audio.context);
        ...
        //wiring
            ...
            object.elements.dial_continuous.frequency_dial.onchange = function(value){object.filterCircuit.frequency( canvas.library.math.curvePoint.exponential(value,0,20000,10.5866095) );updateGraph();};

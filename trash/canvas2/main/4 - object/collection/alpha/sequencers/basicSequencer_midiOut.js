this.basicSequencer_midiOut = function(x,y,debug=false){
    ...
    //calculate pattern basied on midi range
        var temp = vals.sequencer.pattern.length - ['C', 'C#', 'D', 'D#', 'E', 'F', 'F#', 'G', 'G#', 'A', 'A#', 'B'].indexOf(canvas.library.audio.num2name(vals.sequencer.midiRange.top).slice(1))
    ...
    //main object
        var object = canvas.object.builder(this.basicSequencer,design);

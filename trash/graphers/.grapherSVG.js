this.grapherSVG = function(
    ...
    //elements
        ...
        //foreground elements
            var foregroundElements = part.builder('g','foregroundElements',{});
            ...
            for(var a = 0; a < y.length-1; a++){
                ...
                if(points){
                    foregroundElements.append(
                        part.builder('line',null,{x1:points.x1, y1:points.y1, x2:points.x2, y2:points.y2, style:foregroundStyle})
                    );
                }
            }
        };

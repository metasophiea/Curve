_canvas_.control.scene.addUnit(15,50,0,'audio_duplicator');
_canvas_.control.scene.addUnit(100,50,0,'audio_duplicator');
_canvas_.control.scene.addUnit(200,50,1.5,'audio_duplicator');
_canvas_.control.scene.addUnit(300,50,0,'audio_duplicator');
_canvas_.control.scene.removeUnit( _canvas_.control.scene.getUnitByName(1) );
_canvas_.control.scene.addUnit(10,150,0,'basicSynthesizer');

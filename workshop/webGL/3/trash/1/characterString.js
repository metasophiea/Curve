this.characterString = function(){
    ...
    //attributes 
        ...
        //simple attributes
            ...
            this.ignored = false;
            var colour = {r:1,g:0,b:0,a:1}; this.colour = function(a){ if(a==undefined){return colour;} colour = a; if(this.__stopExtremityUpdate){return;} calculateStringCharacters(); };

        //advanced use attributes
            this.__stop_calculateStringCharacters = false;
        
        //attributes pertinent to extremity calculation
            var x = 0;               this.x =     function(a){ if(a==undefined){return x;}     x = a;                                   if(this.__stop_calculateStringCharacters){return;} calculateStringCharacters(); };
            var y = 0;               this.y =     function(a){ if(a==undefined){return y;}     y = a;                                   if(this.__stop_calculateStringCharacters){return;} calculateStringCharacters(); };
            var angle = 0;           this.angle = function(a){ if(a==undefined){return angle;} angle = a;                               if(this.__stop_calculateStringCharacters){return;} calculateStringCharacters(); };
            var width = 10;          this.width =  function(a){ if(a==undefined){return width;}  width = a;                             if(this.__stop_calculateStringCharacters){return;} calculateStringCharacters(); };
            var height = 10;         this.height = function(a){ if(a==undefined){return height;} height = a;                            if(this.__stop_calculateStringCharacters){return;} calculateStringCharacters(); };
            var scale = 1;           this.scale =  function(a){ if(a==undefined){return scale;}  scale = a;                             if(this.__stop_calculateStringCharacters){return;} calculateStringCharacters(); };
            var calculationMode = 0; this.calculationMode = function(a){ if(a==undefined){return calculationMode;} calculationMode = a; if(this.__stop_calculateStringCharacters){return;} calculateStringCharacters(); };
        ...
        //string
            ...
            function calculateStringCharacters(){
                ...
                switch(calculationMode){
                    default: case 0: 
                        ...
                        tmpString.forEach(function(a){
                            if( library.character.vectorLibrary[font][a].ratio == undefined || library.character.vectorLibrary[font][a].ratio.x == undefined ){ mux += 1; }
                        ...
                        for(var a = 0; a < tmpString.length; a++){
                            ...
                            var tmp = _canvas_.core.shape.create('character');
                                tmp.name = ''+a;
                                tmp.__stopExtremityUpdate = true;
                                ...
                                tmp.__stopExtremityUpdate = false;
                                tmp.colour = colour;
                                tmp.parent = self;
                                children.push(tmp);
                ...
                self.updateExtremities();
            }
            this.font = function(a){
                if(a==undefined){return font;}
                font = a == undefined || a === '' || library.character.vectorLibrary[font] == undefined ? 'default' : a;
                if(this.__stop_calculateStringCharacters){return;} 
    ...
    //extremities
        function updateExtremities(informParent=true,offset){

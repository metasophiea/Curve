...
var group4 = canvas.core.arrangement.createElement('group');
    group4.name = 'objectGroup';
    group4.x = 10; group4.y = 120;
    group3.append(group4);

var group5 = canvas.core.arrangement.createElement('group');
    group5.name = 'objectSubGroup';
    group5.angle = -0.3;
    group4.append(group5);

var group6 = canvas.core.arrangement.createElement('group');
    group6.name = 'partGroup';
    group6.x = 100;
    group5.append(group6);

var group7 = canvas.core.arrangement.createElement('group');

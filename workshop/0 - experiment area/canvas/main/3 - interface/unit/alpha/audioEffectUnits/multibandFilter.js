this.multibandFilter = function(
    ...
    //main object
        var object = interfaceUnit.builder(this.multibandFilter,design);
    ...
    //circuitry
        object.filterCircuit_0 = new interface.circuit.alpha.multibandFilter(workspace.library.audio.context, vars.channelCount, true);
        object.filterCircuit_1 = new interface.circuit.alpha.multibandFilter(workspace.library.audio.context, vars.channelCount, true);

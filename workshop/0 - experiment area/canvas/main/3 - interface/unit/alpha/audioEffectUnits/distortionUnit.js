this.distortionUnit = function(x,y){
    ...
    //main object
        var object = interfaceUnit.builder(this.distortionUnit,design);
    ...
    //circuitry
        object.distortionCircuit = new interface.circuit.alpha.distortionUnit(workspace.library.audio.context);

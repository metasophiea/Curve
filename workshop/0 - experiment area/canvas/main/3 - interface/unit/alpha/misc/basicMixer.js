this.basicMixer = function(x,y){
    ...
    //main object
        var object = interfaceUnit.builder(this.basicMixer,design);

    

    //internal circuitry
        for(var a = 0; a < connectionCount; a++){
            object['splitter_'+a] = new interface.circuit.alpha.channelMultiplier(workspace.library.audio.context,2);

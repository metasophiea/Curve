function makeAudioCombiner(x,y){
    ...
    var connectionNode_audio_in_1 = parts.dynamic.connectionNode_audio('connectionNode_audio_in_1',0,5,55-30/2,30,30,system.audio.context);
        _mainObject.append(connectionNode_audio_in_1);
    var connectionNode_audio_in_2 = parts.dynamic.connectionNode_audio('connectionNode_audio_in_2',0,75-30-5,55-30/2,30,30,system.audio.context);
        _mainObject.append(connectionNode_audio_in_2);

    var connectionNode_audio_out_1 = parts.dynamic.connectionNode_audio('connectionNode_audio_out_1',1,75/2-30/2,-30/2,30,30,system.audio.context);

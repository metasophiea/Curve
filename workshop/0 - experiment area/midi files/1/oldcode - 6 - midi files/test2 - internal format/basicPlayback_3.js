...
function makeMidiPlayer(x,y){
    ...
    //generate selection area        
        ...
        _mainObject.updateSelectionArea = function(){
            ...
            var temp = system.utility.element.getBoundingBox(backing);
            _mainObject.selectionArea.points = [
                [temp.x,temp.y],
            ...
            _mainObject.selectionArea.box = system.utility.math.boundingBoxFromPoints(_mainObject.selectionArea.points);

            //adjusting it for the object's position in space
            temp = system.utility.element.getTransform(_mainObject);
    ...
    _mainObject.onSelect = function(){
        ...
        system.utility.element.setStyle(backing, 'fill:rgba(220,220,220,1)');
    };
    _mainObject.onDeselect = function(){
        console.log('I\'ve been deselected!');
        system.utility.element.setStyle(backing, 'fill:rgba(200,200,200,1)');
    };

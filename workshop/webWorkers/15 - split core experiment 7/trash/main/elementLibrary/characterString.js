this.characterString = function(_id,_name){
    ...
    this.string = function(string,useCache=useCache_default){
        ...
        if(useCache && string == undefined){ return cashedAttributes.string; } cashedAttributes.string = string;
    ...
    this.interCharacterSpacing = function(number,useCache=useCache_default){
        ...
        if(useCache && number == undefined){ return cashedAttributes.interCharacterSpacing; } cashedAttributes.interCharacterSpacing = number;

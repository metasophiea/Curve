...
_canvas_.core.meta.go = function(){
    _canvas_.core.meta.createSetAppend( 'group','dynamicGroup', {heedCamera:true} ).then(id => {
        ...
        _canvas_.core.meta.createSetAppend( 'rectangle','rectangle_1', {x:30, y:30, width:200, height:200, colour:{r:0,g:0,b:0,a:1}}, dynamicGroup ).then(id => {
            // callbackNames.forEach(callbackType => { _canvas_.core.callback.attachCallback(id,callbackType,(x,y,event)=>{console.log('rectangle_1 - '+callbackType,x,y,event);}); });
            _canvas_.core.callback.attachCallback(id,'onmouseenterelement',(x,y,event)=>{
                _canvas_.core.element.executeMethod( id, 'colour', [{r:0.75,g:0.75,b:0.75,a:1}]);
                _canvas_.core.render.frame();
            });
            _canvas_.core.callback.attachCallback(id,'onmouseleaveelement',(x,y,event)=>{
                _canvas_.core.element.executeMethod( id, 'colour', [{r:0,g:0,b:0,a:1}]);
                _canvas_.core.render.frame();
            });
        });
        _canvas_.core.meta.createSetAppend( 'rectangle','rectangle_2', {x:60, y:60, width:200, height:200, colour:{r:1,g:1,b:0,a:1}}, dynamicGroup ).then(id => {
            // callbackNames.forEach(callbackType => { _canvas_.core.callback.attachCallback(id,callbackType,(x,y,event)=>{console.log('rectangle_2 - '+callbackType,x,y,event);}); });
            _canvas_.core.callback.attachCallback(id,'onmouseenterelement',(x,y,event)=>{
                _canvas_.core.element.executeMethod( id, 'colour', [{r:0.25,g:0.25,b:0,a:1}]);
                _canvas_.core.render.frame();
            });
            _canvas_.core.callback.attachCallback(id,'onmouseleaveelement',(x,y,event)=>{
                _canvas_.core.element.executeMethod( id, 'colour', [{r:1,g:1,b:0,a:1}]);
                _canvas_.core.render.frame();
            });
        });
        _canvas_.core.meta.createSetAppend( 'rectangle','rectangle_3', {x:90, y:90, width:200, height:200, colour:{r:1,g:0,b:1,a:1}}, dynamicGroup ).then(id => {
            // callbackNames.forEach(callbackType => { _canvas_.core.callback.attachCallback(id,callbackType,(x,y,event)=>{console.log('rectangle_3 - '+callbackType,x,y,event);}); });
            _canvas_.core.callback.attachCallback(id,'onmouseenterelement',(x,y,event)=>{
                _canvas_.core.element.executeMethod( id, 'colour', [{r:1,g:0.75,b:1,a:1,a:1}]);
                _canvas_.core.render.frame();
            });
            _canvas_.core.callback.attachCallback(id,'onmouseleaveelement',(x,y,event)=>{
                _canvas_.core.element.executeMethod( id, 'colour', [{r:1,g:0,b:1,a:1}]);
                _canvas_.core.render.frame();
            });
        });        
    });

workspace.control.scene.addUnit(15,50,0,'audio_duplicator');
workspace.control.scene.addUnit(100,50,0,'audio_duplicator');
workspace.control.scene.addUnit(200,50,1.5,'audio_duplicator');
workspace.control.scene.addUnit(300,50,0,'audio_duplicator');
workspace.control.scene.removeUnit( workspace.control.scene.getUnitByName(1) );
workspace.control.scene.addUnit(10,150,0,'basicSynthesizer');

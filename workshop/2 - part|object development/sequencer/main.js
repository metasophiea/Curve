...
var svg_yrange = system.utility.workspace.placeAndReturnObject( parts.elements.control.rangeslide(undefined,50,40,10,1200,-Math.PI/2) );
svg_yrange.onchange = function(values){svg_seq.viewArea({left:values.start, right:values.end});};
var xrange = system.utility.workspace.placeAndReturnObject( parts.elements.control.rangeslide(undefined,30,50,10,200,0,0.1) );
...
var canvas_yrange = system.utility.workspace.placeAndReturnObject( parts.elements.control.rangeslide(undefined,50,290,10,1200,-Math.PI/2) );
canvas_yrange.onchange = function(values){canvas_seq.viewArea({left:values.start, right:values.end});};
var xrange = system.utility.workspace.placeAndReturnObject( parts.elements.control.rangeslide(undefined,30,300,10,200,0,0.1) );

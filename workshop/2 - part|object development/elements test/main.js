...
//creating first object, adding to pane
    var testObject_1 = system.utility.workspace.placeAndReturnObject( objects.testObject(0,0,true) );

//creating second object, adding to pane
    var testObject_2 = system.utility.workspace.placeAndReturnObject( objects.testObject(600,0,true) );

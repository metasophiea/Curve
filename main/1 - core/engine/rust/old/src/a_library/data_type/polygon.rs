...
impl Polygon {
    ...
    pub fn new_from_flat_array_reference(points:&Vec<f32>) -> Polygon {
        if points.len() %2 != 0 {
            console_warn!("Polygon::new_from_flat_array/new_from_flat_array_reference : provided array is not divisible by 2 : this Polygon will use as many points as possible");
        }
    ...
    pub fn new_from_flat_array(points:Vec<f32>) -> Polygon {
        Polygon::new_from_flat_array_reference(&points)
    }

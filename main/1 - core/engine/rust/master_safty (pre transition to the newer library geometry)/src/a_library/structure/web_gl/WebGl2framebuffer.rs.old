...
struct WebGl2framebuffer_renderbuffer_only {
    id: usize,
...
impl WebGl2framebuffer_renderbuffer_only {
    ...
    pub fn new(context:&WebGl2RenderingContext, id:usize, width:u32, height:u32, samples:u32) -> WebGl2framebuffer_renderbuffer_only {
        ...
        let (renderbuffer_colour, renderbuffer_stencil) = WebGl2framebuffer_renderbuffer_only::produce_and_bind_renderbuffers(context, width, height, samples);

        WebGl2framebuffer_renderbuffer_only {
            id: id,
...
impl WebGl2framebuffer_renderbuffer_only {
    ...
    fn bind(&mut self, context:&WebGl2RenderingContext) {
        if self.is_bound {
            console_error!("{} WebGl2framebuffer_renderbuffer_only.bind - framebuffer already bound!", self.id);
            return;
        }
        ...
        if self.dimensions_or_samples_changed {
            self.dimensions_or_samples_changed = false;
    ...
    fn unbind(&mut self) {
        if !self.is_bound {
            console_error!("{} WebGl2framebuffer_renderbuffer_only.unbind - framebuffer already unbound!", self.id);
            return;
        }
        self.is_bound = false;
    }
    fn copy_to(
        ...
        _texture_rendering_program:Option<&WebGl2programConglomerate>, 
        other: Option<&WebGl2framebuffer_renderbuffer_only>, 
...
struct WebGl2framebuffer_texture {
    id: usize,
    dimensions_or_samples_changed: bool,
    width: u32,
    height: u32,
    ...
    renderbuffer_colour: WebGlRenderbuffer,
    renderbuffer_stencil: WebGlRenderbuffer,
    framebuffer_renderbuffer: WebGlFramebuffer,

    texture: WebGlTexture,
    framebuffer_texture: WebGlFramebuffer,
}
impl WebGl2framebuffer_texture {
    pub fn new(context:&WebGl2RenderingContext, id:usize, width:u32, height:u32, samples:u32) -> WebGl2framebuffer_texture {
        //texture canvas
            let framebuffer_texture = context.create_framebuffer().unwrap();
            context.bind_framebuffer(WebGl2RenderingContext::FRAMEBUFFER, Some(&framebuffer_texture));
        ...
        //renderbuffer canvas
            let framebuffer_renderbuffer = context.create_framebuffer().unwrap();
            context.bind_framebuffer(WebGl2RenderingContext::FRAMEBUFFER, Some(&framebuffer_renderbuffer));
...
impl WebGl2framebuffer_texture {
    ...
    fn bind(&mut self, context:&WebGl2RenderingContext) {
        if self.is_bound {
            console_error!("{} WebGl2framebuffer_texture.bind - framebuffer already bound!", self.id);
            return;
        }
        ...
        if self.dimensions_or_samples_changed {
            ...
            //texture canvas
                context.bind_framebuffer(WebGl2RenderingContext::FRAMEBUFFER, Some(&self.framebuffer_texture));
            ...
            //renderbuffer canvas
                context.bind_framebuffer(WebGl2RenderingContext::FRAMEBUFFER, Some(&self.framebuffer_renderbuffer));
                context.bind_renderbuffer(WebGl2RenderingContext::RENDERBUFFER, Some(&self.renderbuffer_colour));
                context.renderbuffer_storage_multisample(
                    WebGl2RenderingContext::RENDERBUFFER,
                    self.samples as i32,
    ...
    fn unbind(&mut self) {
        if !self.is_bound {
            console_error!("{} WebGl2framebuffer_texture.unbind - framebuffer already unbound!", self.id);
            return;
        }
        self.is_bound = false;
    }
    fn copy_to(
        ...
        other: Option<&WebGl2framebuffer_texture>, 
        web_gl2_program_conglomerate_manager: &mut WebGl2programConglomerateManager
    ) {
        //copy framebuffer_renderbuffer into framebuffer_texture
            context.bind_framebuffer(WebGl2RenderingContext::READ_FRAMEBUFFER, Some(&self.framebuffer_renderbuffer));
            context.read_buffer(WebGl2RenderingContext::COLOR_ATTACHMENT0);

            context.bind_framebuffer(WebGl2RenderingContext::DRAW_FRAMEBUFFER, Some(&self.framebuffer_texture));
            context.draw_buffers(
                &js_sys::Array::of1(
                    &JsValue::from_f64(WebGl2RenderingContext::COLOR_ATTACHMENT0 as f64),
                )
...
impl WebGl2framebuffer_texture {
    fn _dump(&self, prefix:Option<&str>) {
        ...
        console_log!("{}│ renderbuffer_colour: {:?}", prefix, self.renderbuffer_colour);
        console_log!("{}│ renderbuffer_stencil: {:?}", prefix, self.renderbuffer_stencil);
        console_log!("{}│ framebuffer_renderbuffer: {:?}", prefix, self.framebuffer_renderbuffer);
        console_log!("{}│", prefix);
        console_log!("{}│ texture: {:?}", prefix, self.texture);
        console_log!("{}│ framebuffer_texture: {:?}", prefix, self.framebuffer_texture);
    }
}
...
pub struct WebGl2framebufferManager {
    ...
    framebuffer_store: Vec<WebGl2framebuffer_texture>,
    texture_rendering_program: Option<WebGl2programConglomerate>,
}
impl WebGl2framebufferManager {
    ...
    pub fn generate_framebuffer(
        ...
        //generation
            ...
            let framebuffer = WebGl2framebuffer_texture::new(context, id, self.width, self.height, self.samples);

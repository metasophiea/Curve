    ...
    //attributes
        //pertinent to extremity calculation
            //radius
                ...
                pub fn set_radius(&mut self, new:f32) { self.radius = new; self.compute_extremities(true, None); }
            //detail
                pub fn get_detail(&self) -> &u32 { &self.detail }
                pub fn set_detail(&mut self, new:u32) { self.detail = new; self.calculate_circle_points(); self.compute_extremities(true, None); }
            //thickness

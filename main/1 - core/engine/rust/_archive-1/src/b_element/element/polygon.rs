    ...
    //attributes
        //pertinent to extremity calculation
            //points
                ...
                pub fn set_points(&mut self, new:data_type::Polygon, viewbox:&Viewbox) { self.points = new; self.calculate_points(viewbox); self.compute_extremities(true, None, viewbox); }
        //other

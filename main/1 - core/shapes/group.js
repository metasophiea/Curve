...
this.group = function(){
    ...
    //extremities
        ...
        function augmentExtremities_remove(shape){
            ...
            var data = {
                topLeft_x: self.extremities.boundingBox.topLeft.x - shape.extremities.boundingBox.topLeft.x,
                topLeft_y: self.extremities.boundingBox.topLeft.y - shape.extremities.boundingBox.topLeft.y,
                bottomRight_x: shape.extremities.boundingBox.bottomRight.x - self.extremities.boundingBox.bottomRight.x,
                bottomRight_y: shape.extremities.boundingBox.bottomRight.y - self.extremities.boundingBox.bottomRight.y,
            };
            if( data.topLeft_x < 0 && data.topLeft_y < 0 && data.bottomRight_x < 0 && data.bottomRight_y < 0 ){
                ...
                ['topLeft','bottomRight'].forEach(cornerName => {
                    ['x','y'].forEach(axisName => {
                        if(data[cornerName+'_'+axisName] == 0){

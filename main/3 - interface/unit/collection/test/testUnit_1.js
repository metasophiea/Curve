    ...
    var design = {
        ...
        elements:[
            //basic
                ...
                {collection:'basic', type:'image', name:'testImage', data:{ x:40, y:40, width:30, height:30, url:'/images/testImages/mikeandbrian.jpg' } }, 
                {collection:'basic', type:'polygon', name:'testPolygon', data:{ pointsAsXYArray:[{x:55,y:5}, {x:70,y:35}, {x:40,y:35}], colour:{r:0,g:1,b:0,a:1} } }, 
                {collection:'basic', type:'text', name:'testText', data:{ x:7.5, y:95, printingMode:{widthCalculation:'absolute'}, text:'Hello', colour:{r:150/255,g:150/255,b:1,a:1} } }, 
                {collection:'basic', type:'path', name:'testPath', data:{ pointsAsXYArray:[{x:0,y:0},{x:0,y:90},{x:2.5,y:90},{x:2.5,y:72.5},{x:75,y:72.5}] } }, 
            //display
                {collection:'display', type:'glowbox_rect', name:'test_glowbox_rect', data:{x:90,y:0}},
                {collection:'display', type:'sevenSegmentDisplay', name:'test_sevenSegmentDisplay', data:{x:125,y:0}},
                {collection:'display', type:'sixteenSegmentDisplay', name:'test_sixteenSegmentDisplay', data:{x:150,y:0}},
                {collection:'display', type:'readout_sixteenSegmentDisplay', name:'test_readout_sixteenSegmentDisplay', data:{x:175,y:0}},
                {collection:'display', type:'level', name:'test_level1', data:{x:90, y:35}},
                {collection:'display', type:'meter_level', name:'test_meterLevel1', data:{x:115, y:35}},
                {collection:'display', type:'audio_meter_level', name:'test_audioMeterLevel1', data:{x:140, y:35}},
                {collection:'display', type:'rastorDisplay', name:'test_rastorDisplay1', data:{x:165, y:35}},
                {collection:'display', type:'grapher', name:'test_grapher1', data:{x:230, y:35}},
                {collection:'display', type:'grapher_periodicWave', name:'test_grapher_periodicWave1', data:{x:355, y:35}},
                {collection:'display', type:'grapher_audioScope', name:'test_grapher_audioScope1', data:{x:480, y:35}},
            //control
                {collection:'control', type:'slide', name:'test_slide1', data:{x:0,y:110}},
                {collection:'control', type:'slidePanel', name:'test_slidePanel1', data:{x:15,y:110}},
                {collection:'control', type:'slide', name:'test_slide2', data:{x:0,y:220,angle:-Math.PI/2}},
                {collection:'control', type:'slidePanel', name:'test_slidePanel2', data:{x:0,y:305,angle:-Math.PI/2}},
                {collection:'control', type:'rangeslide', name:'test_rangeslide1', data:{x:100,y:110}},
                {collection:'control', type:'rangeslide', name:'test_rangeslide2', data:{x:100,y:220,angle:-Math.PI/2}},
                {collection:'control', type:'dial_continuous', name:'test_dial_continuous1', data:{x:130,y:125}},
                {collection:'control', type:'dial_discrete', name:'test_dial_discrete1', data:{x:170,y:125}},
                {collection:'control', type:'button_rectangle', name:'test_button_rectangle1', data:{x:115,y:145}},

                {collection:'control', type:'list', name:'test_list1', data:{x:185,y:225,limitHeightTo:100,list:[
                    { type:'space' },
                ...
                {collection:'control', type:'checkbox_rectangle', name:'test_checkbox_rect1', data:{x:150,y:145}},
                {collection:'control', type:'rastorgrid', name:'test_rastorgrid1', data:{x:100,y:225}},
                {collection:'control', type:'needleOverlay', name:'test_needleOverlay1', data:{x:0,y:310}},
                {collection:'control', type:'grapher_waveWorkspace', name:'test_grapher_waveWorkspace1', data:{x:0,y:375}},
                {collection:'control', type:'sequencer', name:'test_sequencer1', data:{x:125,y:330}},
            //dynamic nodes
                {collection:'dynamic', type:'connectionNode', name:'test_connectionNode1', data:{ x:255, y:135 }},
                {collection:'dynamic', type:'connectionNode', name:'test_connectionNode2', data:{ x:230, y:185 }},
                {collection:'dynamic', type:'connectionNode', name:'test_connectionNode3', data:{ x:280, y:185 }},
                {collection:'dynamic', type:'connectionNode_signal', name:'test_connectionNode_signal1', data:{ x:355, y:135 }},
                {collection:'dynamic', type:'connectionNode_signal', name:'test_connectionNode_signal2', data:{ x:330, y:185 }},
                {collection:'dynamic', type:'connectionNode_signal', name:'test_connectionNode_signal3', data:{ x:380, y:185 }},
                {collection:'dynamic', type:'connectionNode_voltage', name:'test_connectionNode_voltage1', data:{ x:455, y:135 }},
                {collection:'dynamic', type:'connectionNode_voltage', name:'test_connectionNode_voltage2', data:{ x:430, y:185 }},
                {collection:'dynamic', type:'connectionNode_voltage', name:'test_connectionNode_voltage3', data:{ x:480, y:185 }},
                {collection:'dynamic', type:'connectionNode_data', name:'test_connectionNode_data1', data:{ x:555, y:135 }},
                {collection:'dynamic', type:'connectionNode_data', name:'test_connectionNode_data2', data:{ x:530, y:185 }},
                {collection:'dynamic', type:'connectionNode_data', name:'test_connectionNode_data3', data:{ x:580, y:185 }},
                {collection:'dynamic', type:'connectionNode_audio', name:'test_connectionNode_audio1', data:{ x:655, y:135, isAudioOutput:true}},
                {collection:'dynamic', type:'connectionNode_audio', name:'test_connectionNode_audio2', data:{ x:630, y:185 }},
                {collection:'dynamic', type:'connectionNode_audio', name:'test_connectionNode_audio3', data:{ x:680, y:185 }},
        ],
    };

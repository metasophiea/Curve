this.rangeslide = function(
    ...
    //elements 
        ...
        //backing and slot group
            ...
            //slot
                var slot = interfacePart.builder('basic','rectangle','slot',{x:width*0.45, y:(height*(handleHeight/2)), width:width*0.1, height:height*(1-handleHeight), colour:slotStyle});
        ...
        //span
            var span = interfacePart.builder('basic','rectangle','span',{x:width*((1-spanWidth)/2), y:height*handleHeight, width:width*spanWidth, height:height - 2*height*handleHeight, colour:spanStyle });
            object.append(span);
        ...
        //handles
            ...
            for(var a = 0; a < handleNames.length; a++){
                ...
                //handle
                    var handle = interfacePart.builder('basic','rectangle','handle',{width:width,height:height*handleHeight, colour:handleStyle});

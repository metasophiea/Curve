...
//                     }},
//                     {collection:'control', type:'dial_2_continuous',name:'gainWobblePeriod',data:{
//                         x:40, y:62.5, radius:25/2, startAngle:(3*Math.PI)/4, maxAngle:1.5*Math.PI, value:0.5, arcDistance:1.2, resetValue:0.5, style:unitStyle.gainWobblePeriod,
//                     }},
//                     {collection:'control', type:'dial_2_continuous',name:'gainWobbleDepth',data:{
//                         x:40, y:92.5, radius:25/2, startAngle:(3*Math.PI)/4, maxAngle:1.5*Math.PI, value:0, arcDistance:1.2, resetValue:0, style:unitStyle.gainWobbleDepth,
//                     }},
//                     {collection:'control', type:'dial_2_continuous',name:'detuneWobblePeriod',data:{
//                         x:72.5, y:62.5, radius:25/2, startAngle:(3*Math.PI)/4, maxAngle:1.5*Math.PI, value:0.5, arcDistance:1.2, resetValue:0.5, style:unitStyle.detuneWobblePeriod,
//                     }},
//                     {collection:'control', type:'dial_2_continuous',name:'detuneWobbleDepth',data:{
//                         x:72.5, y:92.5, radius:25/2, startAngle:(3*Math.PI)/4, maxAngle:1.5*Math.PI, value:0, arcDistance:1.2, resetValue:0, style:unitStyle.detuneWobbleDepth,
//                     }},
...
//     //circuitry
//         const detuneLimits = {min:-100, max:100};
//         const envelope = {attack:0, release:0};
//         const synthesizerCircuit = new _canvas_.interface.circuit.synthesizer(_canvas_.library.audio.context);

//     //wiring
//         //hid
//             object.elements.dial_2_continuous.outputGain.onchange = function(value){
//                 synthesizerCircuit.masterGain( value );
//             };
//             object.elements.dial_2_continuous.attack.onchange = function(value){
//                 envelope.attack = value;
//                 synthesizerCircuit.gain.envelope(
//                     {
//                         front:[ {destination:1, elapse:envelope.attack } ],
//                         back:[ {destination:0, elapse:envelope.release } ],
//                     }
//                 );
//             };
//             object.elements.dial_2_continuous.release.onchange = function(value){
...
//                 );
//             };
//             object.elements.dial_2_continuous.detune_note.onchange = function(value){
//                 synthesizerCircuit.detune.manual.value(
//                     (value*(detuneLimits.max-detuneLimits.min) + detuneLimits.min)/10
//                 );
//             };
//             object.elements.dial_2_discrete.detune_octave.onchange = function(value){
//                 synthesizerCircuit.octave( value-3 );
//             };
//             object.elements.dial_2_discrete.periodicWaveType.onchange = function(value){
//                 switch(value){
//                     case 0: 
//                         synthesizerCircuit.waveform('sine');
//                     break;
//                     case 1: 
//                         synthesizerCircuit.waveform('triangle');
//                         synthesizerCircuit.dutyCycle.manual.value(0.5);
//                     break;
//                     case 2: 
//                         synthesizerCircuit.waveform('square');
//                         synthesizerCircuit.dutyCycle.manual.value(0.5);
//                     break;
//                     case 3: //sawtooth
//                         synthesizerCircuit.waveform('triangle');
//                         synthesizerCircuit.dutyCycle.manual.value(0);
//                     break;
//                     case 4: 
//                         synthesizerCircuit.waveform('additiveSynthesis');
//                     break;
//                 }
//             };
//             object.elements.dial_2_continuous.gainWobblePeriod.onchange = function(value){
//                 synthesizerCircuit.gain.internalLFO.period( value == 0 ? 0.001 : value*2 );
//             };
//             object.elements.dial_2_continuous.gainWobbleDepth.onchange = function(value){
//                 synthesizerCircuit.gain.internalLFO.depth( value );
//             };
//             object.elements.dial_2_continuous.detuneWobblePeriod.onchange = function(value){
//                 synthesizerCircuit.detune.internalLFO.period( value == 0 ? 0.001 : value*2 );
//             };
//             object.elements.dial_2_continuous.detuneWobbleDepth.onchange = function(value){ 
//                 synthesizerCircuit.detune.internalLFO.depth( value );
//             };
//             object.elements.button_circle.panicButton.onpress = function(){
//                 synthesizerCircuit.panic();
//             };
//         //io
//             object.io.audio.io_output.audioNode = synthesizerCircuit.out();
...
//             object.io.data.io_periodicWaveType_dataIn.onreceive = function(address,data){
//                 if(address != 'periodicWave'){return;}
//                 synthesizerCircuit.additiveSynthesis.sin(data.sin);
//                 synthesizerCircuit.additiveSynthesis.cos(data.cos);
//             };
//             object.io.voltage.io_outputGain.onchange = function(value){
//                 object.elements.dial_2_continuous.outputGain.set(value);
//             };
...
//     //interface
//         object.i = {
//             periodicWave:function(data){
//                 if(data == undefined){ return {sin:synthesizerCircuit.additiveSynthesis.sin(), cos:synthesizerCircuit.additiveSynthesis.cos()}; }
//                 synthesizerCircuit.additiveSynthesis.sin(data.sin);
//                 synthesizerCircuit.additiveSynthesis.cos(data.cos);
//             },
//             performMidiNote:function(data){synthesizerCircuit.perform(data);},
...
//     //setup/tearDown
//         object.oncreate = function(){
//             synthesizerCircuit.masterGain( 0.5 );
//             synthesizerCircuit.gain.mode('internalLFO');
//             synthesizerCircuit.detune.mode('internalLFO');
//             object.elements.dial_2_continuous.gainWobblePeriod.set(0.5);
//             object.elements.dial_2_continuous.detuneWobblePeriod.set(0.5);
//         };
//         object.ondelete = function(){
//         };
